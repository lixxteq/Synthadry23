...
namespace TheVegetationEngine
{
    public class TVEMaterialManager : EditorWindow
    {
        ...
        {
            new TVEMaterialData("_CategoryRender", "Render Settings", false),
            ...
            new TVEMaterialData("_SpaceFade", false),

            new TVEMaterialData("_FadeConstantValue", "Fade by Constant Value", -9999, 0, 1, false, false),
        ...
        {
            new TVEMaterialData("_CategoryGlobals", "Global Settings", false),
            ...
            new TVEMaterialData("_SpaceGlobalLayers", false),
            ...
            new TVEMaterialData("_SpaceGlobalLocals", false),
            ...
            new TVEMaterialData("_SpaceGlobalOptions", false),

            new TVEMaterialData("_ColorsMaskMode", "Use Ground Mask for Color", -9999, false),
        ...
        {
            new TVEMaterialData("_CategoryMain", "Main Settings", false),
        ...
        {
            new TVEMaterialData("_CategoryDetail", "Detail Settings", false),
        ...
        {
            new TVEMaterialData("_CategoryOcclusion", "Occlusion Settings", false),
        ...
        {
            new TVEMaterialData("_CategoryGradient", "Gradient Settings", false),
        ...
        {
            new TVEMaterialData("_CategoryNoise", "Noise Settings", false),
        ...
        {
            new TVEMaterialData("_CategorySubsurface", "Subsurface Settings", false),

            new TVEMaterialData("_SubsurfaceValue", "Subsurface Intensity", -9999, 0, 1, false, false),

            new TVEMaterialData("_SubsurfaceColor", "Subsurface Color", new Color(-9999, 0,0,0), true, true),
            new TVEMaterialData("_SubsurfaceScatteringValue", "Subsurface Power", -9999, 0, 16, false, true),
        ...
        {
            new TVEMaterialData("_CategoryEmissive", "Emissive Settings", false),
        ...
        {
            new TVEMaterialData("_CategoryPerspective", "Perspective Settings", false),
        ...
        {
            new TVEMaterialData("_CategorySizeFade", "Size Fade Settings", false),
        ...
        {
            new TVEMaterialData("_CategoryMotion", "Motion Settings", false),
            ...
            new TVEMaterialData("_SpaceMotionLocals", false),
        ...
        void OnGUI()
        {
            ...
            if (isValid && selectedMaterials.Count > 0)
            {
                ...
                {
                    EditorGUILayout.HelpBox("Procedural variation in use! Use the Motion Scale settings if the Variation is splitting the mesh!", MessageType.Info, true);
                }
                else
                {
            ...
            for (int i = 0; i < materialData.Count; i++)
            {
                ...
                else if (materialData[i].type == TVEMaterialData.PropertyType.Category)
                {
                    ...
                    {
                        GUILayout.Space(10);
                        StyledGUI.DrawWindowCategory(materialData[i].category);
                        GUILayout.Space(10);
                    }
                }
            }
        ...
        void InitCustomMaterials()
        {
            ...
            if (TVEMaterial != null)
            {
                for (int i = 0; i < selectedMaterials.Count; i++)
                {
                    ...
                    {
                        if (material.GetInt("_VertexVariationMode") == 1)
                        {
        ...
        void GetMaterialProperties()
        {
            for (int i = 0; i < selectedMaterials.Count; i++)
            {
                ...
                for (int d = 0; d < materialData.Count; d++)
                {
                    ...
                    //if (material.GetTag("RenderPipeline", false) == "HDRenderPipeline" || material.shader.name.Contains("Standard") || material.shader.name.Contains("Simple") || material.shader.name.Contains("Vertex"))
                    //{
                    //    if (materialData[d].prop == "_SubsurfaceNormalValue")
                    //        continue;
                    //    if (materialData[d].prop == "_SubsurfaceDirectValue")
                    //        continue;
                    //    if (materialData[d].prop == "_SubsurfaceAmbientValue")
                    //        continue;
                    //    if (materialData[d].prop == "_SubsurfaceShadowValue")
                    //        continue;
                    //}

                    if (materialData[d].type == TVEMaterialData.PropertyType.Range || materialData[d].type == TVEMaterialData.PropertyType.Value)
                    {
