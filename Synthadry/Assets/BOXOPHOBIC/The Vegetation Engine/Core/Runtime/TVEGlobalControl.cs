...
namespace TheVegetationEngine
{
    ...
    public class TVEGlobalControl : StyledMonoBehaviour
    {
        ...
        [StyledMessage("Info", "The overlay texures are disabled for the built-in shaders. They will only be used for shaders compiled with the Overlay Quality option set to Standard on the Amplify Base function!", 0, 0)]
        ...
        [Tooltip("Controls the global overlay height starting point in world units.")]
        public float overlayHeightStart = -1000f;
        [Tooltip("Controls the global overlay height ending point in world units.")]
        public float overlayHeightEnd = -1000f;
        ...
        [Range(0.0f, 20.0f)]
        public float screenNoiseScale = 1.0f;
        ...
        void SetGlobalShaderProperties()
        {
            ...
            Shader.SetGlobalFloat("TVE_OverlayHeightStart", overlayHeightStart);
            Shader.SetGlobalFloat("TVE_OverlayHeightEnd", overlayHeightEnd);
