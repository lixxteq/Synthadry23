	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 tex2DNode17_g19342 = tex2D( _MainTex, ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw ) );
				half temp_output_7_0_g20833 = _MainTexMinValue;
				half4 temp_cast_0 = (temp_output_7_0_g20833).xxxx;
				half4 break469_g19342 = saturate( ( ( tex2DNode17_g19342 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g20833 ) ) );
				half MainTex_R73_g19342 = break469_g19342.r;
				half Base_Extras_RGB213_g19342 = ( lerpResult181_g19342 * MainTex_R73_g19342 * i.ase_color.r );
				half temp_output_9_0_g20843 = Base_Extras_RGB213_g19342;
				half sRGB8_g20843 = temp_output_9_0_g20843;
				half localGammaToLinearFloatFast8_g20843 = GammaToLinearFloatFast( sRGB8_g20843 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g20843 = temp_output_9_0_g20843;
				#else
				float staticSwitch1_g20843 = localGammaToLinearFloatFast8_g20843;
				#endif
				half3 appendResult890_g19342 = (half3(staticSwitch1_g20843 , 0.0 , 0.0));
				half3 Final_Emissive_RGB886_g19342 = appendResult890_g19342;
				half MainTex_A74_g19342 = break469_g19342.a;
				...
				half2 temp_output_851_0_g19342 = saturate( ( ( abs( (( (temp_output_35_0_g20854).zw + ( (temp_output_35_0_g20854).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g20862 ) ) );
				half2 break852_g19342 = ( temp_output_851_0_g19342 * temp_output_851_0_g19342 );
				...
				half Final_Emissive_A884_g19342 = ( MainTex_A74_g19342 * Element_Intensity56_g19342 );
...
/*ASEBEGIN
Version=19102
Node;AmplifyShaderEditor.FunctionNode;113;-640,-1408;Inherit;False;Define Element Extras;66;;19324;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;118;-640,-1152;Inherit;False;Base Element;2;;19342;0e972c73cae2ee54ea51acc9738801d0;6,477,1,478,0,145,0,481,0,576,1,491,1;0;1;FLOAT4;0
...
ASEEND*/
//CHKSM=F8A20E010D35104B85DFBD6FF907D798A652FC27