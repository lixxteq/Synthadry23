	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 break469_g20498 = saturate( ( ( tex2DNode17_g20498 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g20833 ) ) );
				half MainTex_R73_g20498 = break469_g20498.r;
				...
				float2 temp_cast_1 = (temp_output_7_0_g20862).xx;
				float2 temp_output_851_0_g20498 = saturate( ( ( abs( (( (temp_output_35_0_g20854).zw + ( (temp_output_35_0_g20854).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g20862 ) ) );
...
/*ASEBEGIN
Version=19102
Node;AmplifyShaderEditor.FunctionNode;136;-768,-1280;Inherit;False;Define Element Vertex;66;;20497;9f8670cd8fdc98444822270656343d82;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;133;-608,-1152;Inherit;False;Property;_render_dst;_render_dst;69;1;[HideInInspector];Create;True;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;132;-768,-1152;Inherit;False;Property;_render_src;_render_src;68;1;[HideInInspector];Create;True;0;0;0;True;0;False;2;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;131;-768,-1025;Inherit;False;Base Element;2;;20498;0e972c73cae2ee54ea51acc9738801d0;6,477,3,478,0,145,1,481,2,576,1,491,1;0;1;FLOAT4;0
...
ASEEND*/
//CHKSM=C31223A7642BFDF56CC3918ED5A2B006750CA588