	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 tex2DNode17_g20889 = tex2D( _MainTex, ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw ) );
				half temp_output_7_0_g20891 = _MainTexMinValue;
				half4 temp_cast_0 = (temp_output_7_0_g20891).xxxx;
				half4 break469_g20889 = saturate( ( ( tex2DNode17_g20889 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g20891 ) ) );
				half MainTex_R73_g20889 = break469_g20889.r;
				half Base_Extras_RGB213_g20889 = ( lerpResult181_g20889 * MainTex_R73_g20889 * i.ase_color.r );
				...
				half MainTex_A74_g20889 = break469_g20889.a;
				half4 Colors37_g20896 = TVE_ColorsCoords;
				half4 Extras37_g20896 = TVE_ExtrasCoords;
				half4 Motion37_g20896 = TVE_MotionCoords;
				half4 Vertex37_g20896 = TVE_VertexCoords;
				half4 localIS_ELEMENT37_g20896 = IS_ELEMENT( Colors37_g20896 , Extras37_g20896 , Motion37_g20896 , Vertex37_g20896 );
				half4 temp_output_35_0_g20897 = localIS_ELEMENT37_g20896;
				half temp_output_7_0_g20903 = TVE_ElementsFadeValue;
				half2 temp_cast_1 = (temp_output_7_0_g20903).xx;
				half2 temp_output_851_0_g20889 = saturate( ( ( abs( (( (temp_output_35_0_g20897).zw + ( (temp_output_35_0_g20897).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g20903 ) ) );
				half2 break852_g20889 = ( temp_output_851_0_g20889 * temp_output_851_0_g20889 );
				...
				half Final_MotionControl_A523_g20889 = ( MainTex_A74_g20889 * Element_Intensity56_g20889 );
...
/*ASEBEGIN
Version=19102
Node;AmplifyShaderEditor.FunctionNode;131;-256,-1536;Inherit;False;Define Element Motion;66;;19304;6eebc31017d99e84e811285e6a5d199d;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;183;-256,-1280;Inherit;False;Base Element;2;;20889;0e972c73cae2ee54ea51acc9738801d0;6,477,2,478,0,145,3,481,0,576,1,491,1;0;1;FLOAT4;0
...
ASEEND*/
//CHKSM=2D3425706CD7AB7C7FADCE7CD72FC1A7B34D5B34