	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				half3 Input_Position419_g75726 = WorldPosition3905_g75662;
				float Input_MotionScale287_g75726 = ( _MotionScale_10 + 0.2 );
				half Global_NoiseScale448_g75726 = TVE_NoiseParams.x;
				float2 temp_output_597_0_g75726 = (( Input_Position419_g75726 * Input_MotionScale287_g75726 * Global_NoiseScale448_g75726 * 0.0075 )).xz;
				float2 temp_output_447_0_g75707 = ((TVE_MotionParams).xy*2.0 + -1.0);
				half2 Global_Wind_DirectionWS4683_g75662 = temp_output_447_0_g75707;
				half2 Input_DirectionWS423_g75726 = Global_Wind_DirectionWS4683_g75662;
				half Input_MotionSpeed62_g75726 = _MotionSpeed_10;
				half Global_NoiseSpeed449_g75726 = TVE_NoiseParams.y;
				half Input_MotionVariation284_g75726 = _MotionVariation_10;
				float3 localObjectPosition_UNITY_MATRIX_M14_g75695 = ObjectPosition_UNITY_MATRIX_M();
				float3 appendResult60_g75701 = (float3(inputMesh.ase_texcoord3.x , inputMesh.ase_texcoord3.z , inputMesh.ase_texcoord3.y));
				half3 Mesh_PivotsData2831_g75662 = ( appendResult60_g75701 * _VertexPivotMode );
				float3 temp_output_122_0_g75695 = Mesh_PivotsData2831_g75662;
				float3 PivotsOnly105_g75695 = (mul( GetObjectToWorldMatrix(), float4( temp_output_122_0_g75695 , 0.0 ) ).xyz).xyz;
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g75695 = ( ( localObjectPosition_UNITY_MATRIX_M14_g75695 + PivotsOnly105_g75695 ) + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g75695 = ( localObjectPosition_UNITY_MATRIX_M14_g75695 + PivotsOnly105_g75695 );
				#endif
				half3 ObjectData20_g75696 = staticSwitch13_g75695;
				half3 WorldData19_g75696 = ase_worldPos;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g75696 = WorldData19_g75696;
				#else
				float3 staticSwitch14_g75696 = ObjectData20_g75696;
				#endif
				float3 temp_output_114_0_g75695 = staticSwitch14_g75696;
				float3 vertexToFrag4224_g75662 = temp_output_114_0_g75695;
				half3 ObjectData20_g75692 = vertexToFrag4224_g75662;
				half3 WorldData19_g75692 = vertexToFrag3890_g75662;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g75692 = WorldData19_g75692;
				#else
				float3 staticSwitch14_g75692 = ObjectData20_g75692;
				#endif
				float3 ObjectPosition4223_g75662 = staticSwitch14_g75692;
				float3 break111_g75748 = ObjectPosition4223_g75662;
				half Global_DynamicMode5112_g75662 = _VertexDynamicMode;
				half Input_DynamicMode120_g75748 = Global_DynamicMode5112_g75662;
				float Postion_Sum142_g75748 = ( ( break111_g75748.x + break111_g75748.y + break111_g75748.z + 0.001275 ) * ( 1.0 - Input_DynamicMode120_g75748 ) );
				float Mesh_Variation16_g75662 = inputMesh.ase_color.r;
				half Input_Variation124_g75748 = Mesh_Variation16_g75662;
				half ObjectData20_g75750 = ( Postion_Sum142_g75748 + Input_Variation124_g75748 );
				half WorldData19_g75750 = Input_Variation124_g75748;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g75750 = WorldData19_g75750;
				#else
				float staticSwitch14_g75750 = ObjectData20_g75750;
				#endif
				float clampResult129_g75748 = clamp( frac( staticSwitch14_g75750 ) , 0.01 , 0.99 );
				float Global_MeshVariation5104_g75662 = clampResult129_g75748;
				half Input_GlobalMeshVariation569_g75726 = Global_MeshVariation5104_g75662;
				half Input_ObjectVariation694_g75726 = _MotionObjectVariation;
				half ObjectData20_g75751 = Postion_Sum142_g75748;
				half WorldData19_g75751 = 0.0;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g75751 = WorldData19_g75751;
				#else
				float staticSwitch14_g75751 = ObjectData20_g75751;
				#endif
				float Global_ObjectVariation6217_g75662 = staticSwitch14_g75751;
				half Input_GlobalObjectVariation692_g75726 = Global_ObjectVariation6217_g75662;
				float temp_output_630_0_g75726 = ( ( ( _TimeParameters.x * Input_MotionSpeed62_g75726 * Global_NoiseSpeed449_g75726 ) + ( Input_MotionVariation284_g75726 * Input_GlobalMeshVariation569_g75726 ) + ( Input_ObjectVariation694_g75726 * Input_GlobalObjectVariation692_g75726 ) ) * 0.03 );
				float temp_output_607_0_g75726 = frac( temp_output_630_0_g75726 );
				float4 lerpResult590_g75726 = lerp( SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( temp_output_597_0_g75726 + ( -Input_DirectionWS423_g75726 * temp_output_607_0_g75726 ) ), 0.0 ) , SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( temp_output_597_0_g75726 + ( -Input_DirectionWS423_g75726 * frac( ( temp_output_630_0_g75726 + 0.5 ) ) ) ), 0.0 ) , ( abs( ( temp_output_607_0_g75726 - 0.5 ) ) / 0.5 ));
				float2 temp_output_645_0_g75726 = ((lerpResult590_g75726).rg*2.0 + -1.0);
				float2 break650_g75726 = temp_output_645_0_g75726;
				float3 appendResult649_g75726 = (float3(break650_g75726.x , 0.0 , break650_g75726.y));
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				half2 Global_Noise_OS5548_g75662 = (( mul( GetWorldToObjectMatrix(), float4( appendResult649_g75726 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Noise_DirectionOS487_g75735 = Global_Noise_OS5548_g75662;
				float2 break448_g75707 = temp_output_447_0_g75707;
				float3 appendResult452_g75707 = (float3(break448_g75707.x , 0.0 , break448_g75707.y));
				half2 Global_Wind_DirectionOS5692_g75662 = (( mul( GetWorldToObjectMatrix(), float4( appendResult452_g75707 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Wind_DirectionOS458_g75735 = Global_Wind_DirectionOS5692_g75662;
				float4 temp_output_91_19_g75684 = TVE_MotionCoords;
				half2 UV94_g75684 = ( (temp_output_91_19_g75684).zw + ( (temp_output_91_19_g75684).xy * (ObjectPosition4223_g75662).xz ) );
				float temp_output_84_0_g75684 = _LayerMotionValue;
				float4 lerpResult107_g75684 = lerp( TVE_MotionParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_MotionTex, sampler_Linear_Clamp, UV94_g75684,temp_output_84_0_g75684, 0.0 ) , TVE_MotionUsage[(int)temp_output_84_0_g75684]);
				half4 Global_Motion_Params3909_g75662 = lerpResult107_g75684;
				float4 break322_g75707 = Global_Motion_Params3909_g75662;
				half Global_Wind_Power2223_g75662 = break322_g75707.z;
				half Input_WindPower449_g75735 = Global_Wind_Power2223_g75662;
				float temp_output_565_0_g75735 = ( 1.0 - Input_WindPower449_g75735 );
				float2 lerpResult516_g75735 = lerp( Input_Noise_DirectionOS487_g75735 , Input_Wind_DirectionOS458_g75735 , ( ( 1.0 - ( temp_output_565_0_g75735 * temp_output_565_0_g75735 * temp_output_565_0_g75735 ) ) * 0.6 ));
				half Mesh_Height1524_g75662 = inputMesh.ase_color.a;
				half Input_MeshHeight388_g75735 = Mesh_Height1524_g75662;
				half ObjectData20_g75736 = ( Input_MeshHeight388_g75735 * 2.0 );
				float enc62_g75703 = inputMesh.ase_texcoord.w;
				float2 localDecodeFloatToVector262_g75703 = DecodeFloatToVector2( enc62_g75703 );
				float2 break63_g75703 = ( localDecodeFloatToVector262_g75703 * 100.0 );
				float Bounds_Height5230_g75662 = break63_g75703.x;
				half Input_BoundsHeight390_g75735 = Bounds_Height5230_g75662;
				half WorldData19_g75736 = ( ( Input_MeshHeight388_g75735 * Input_MeshHeight388_g75735 ) * Input_BoundsHeight390_g75735 * 2.0 );
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g75736 = WorldData19_g75736;
				#else
				float staticSwitch14_g75736 = ObjectData20_g75736;
				#endif
				half Final_Motion_10_Amplitude321_g75735 = staticSwitch14_g75736;
				half Motion_10_Amplitude2258_g75662 = _MotionAmplitude_10;
				half Input_BendingAmplitude376_g75735 = Motion_10_Amplitude2258_g75662;
				float2 appendResult433_g75707 = (float2(break322_g75707.x , break322_g75707.y));
				float2 temp_output_436_0_g75707 = (appendResult433_g75707*2.0 + -1.0);
				float2 break441_g75707 = temp_output_436_0_g75707;
				float3 appendResult440_g75707 = (float3(break441_g75707.x , 0.0 , break441_g75707.y));
				half2 Global_React_DirectionOS39_g75662 = (( mul( GetWorldToObjectMatrix(), float4( appendResult440_g75707 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_React_DirectionOS358_g75735 = Global_React_DirectionOS39_g75662;
				half Input_InteractionAmplitude58_g75735 = _InteractionAmplitude;
				half Input_InteractionUseMask62_g75735 = _InteractionMaskValue;
				float lerpResult371_g75735 = lerp( 2.0 , Final_Motion_10_Amplitude321_g75735 , Input_InteractionUseMask62_g75735);
				half ObjectData20_g75737 = lerpResult371_g75735;
				half WorldData19_g75737 = Final_Motion_10_Amplitude321_g75735;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g75737 = WorldData19_g75737;
				#else
				float staticSwitch14_g75737 = ObjectData20_g75737;
				#endif
				half Final_InteractionAmplitude373_g75735 = ( Input_InteractionAmplitude58_g75735 * staticSwitch14_g75737 );
				half Global_Interaction_Mask66_g75662 = ( break322_g75707.w * break322_g75707.w * break322_g75707.w * break322_g75707.w );
				float Input_InteractionGlobalMask330_g75735 = Global_Interaction_Mask66_g75662;
				half Final_InteractionMask525_g75735 = saturate( ( Input_InteractionAmplitude58_g75735 * Input_InteractionGlobalMask330_g75735 ) );
				float2 lerpResult551_g75735 = lerp( ( lerpResult516_g75735 * ( Final_Motion_10_Amplitude321_g75735 * Input_BendingAmplitude376_g75735 * ( Input_WindPower449_g75735 * Input_WindPower449_g75735 ) ) ) , ( Input_React_DirectionOS358_g75735 * Final_InteractionAmplitude373_g75735 ) , Final_InteractionMask525_g75735);
				float2 break364_g75735 = lerpResult551_g75735;
				half Motion_10_BendingZ190_g75662 = break364_g75735.y;
				half Angle44_g75664 = Motion_10_BendingZ190_g75662;
				half3 VertexPos40_g75672 = ( VertexPosRotationAxis50_g75664 + ( VertexPosOtherAxis82_g75664 * cos( Angle44_g75664 ) ) + ( cross( float3(1,0,0) , VertexPosOtherAxis82_g75664 ) * sin( Angle44_g75664 ) ) );
				float3 appendResult74_g75672 = (float3(0.0 , 0.0 , VertexPos40_g75672.z));
				half3 VertexPosRotationAxis50_g75672 = appendResult74_g75672;
				float3 break84_g75672 = VertexPos40_g75672;
				float3 appendResult81_g75672 = (float3(break84_g75672.x , break84_g75672.y , 0.0));
				half3 VertexPosOtherAxis82_g75672 = appendResult81_g75672;
				half Motion_10_BendingX216_g75662 = break364_g75735.x;
				half Angle44_g75672 = -Motion_10_BendingX216_g75662;
				float3 Vertex_Motion_Object833_g75662 = ( VertexPosRotationAxis50_g75672 + ( VertexPosOtherAxis82_g75672 * cos( Angle44_g75672 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g75672 ) * sin( Angle44_g75672 ) ) );
				...
				float4 temp_output_94_19_g75688 = TVE_VertexCoords;
				half2 UV97_g75688 = ( (temp_output_94_19_g75688).zw + ( (temp_output_94_19_g75688).xy * (ObjectPosition4223_g75662).xz ) );
				float temp_output_84_0_g75688 = _LayerVertexValue;
				float4 lerpResult109_g75688 = lerp( TVE_VertexParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_VertexTex, sampler_Linear_Clamp, UV97_g75688,temp_output_84_0_g75688, 0.0 ) , TVE_VertexUsage[(int)temp_output_84_0_g75688]);
				half4 Global_Vertex_Params4173_g75662 = lerpResult109_g75688;
				...
				half3 ObjectData20_g75674 = appendResult3480_g75662;
				half3 _Vector11 = half3(1,1,1);
				half3 WorldData19_g75674 = _Vector11;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g75674 = WorldData19_g75674;
				#else
				float3 staticSwitch14_g75674 = ObjectData20_g75674;
				#endif
				half3 Vertex_Size1741_g75662 = staticSwitch14_g75674;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g75662 = _Vector5;
				float3 lerpResult16_g75673 = lerp( VertexPosition3588_g75662 , ( ( ( staticSwitch4976_g75662 + Grass_Perspective2661_g75662 ) * Vertex_Size1741_g75662 * Vertex_SizeFade1740_g75662 ) + Mesh_PivotsOS2291_g75662 ) , TVE_Enabled);
				float3 Final_VertexPosition890_g75662 = ( lerpResult16_g75673 + _DisableSRPBatcher );
				
				float temp_output_7_0_g75724 = _GradientMinValue;
				half Gradient_Tint2784_g75662 = saturate( ( ( Mesh_Height1524_g75662 - temp_output_7_0_g75724 ) / ( _GradientMaxValue - temp_output_7_0_g75724 ) ) );
				float vertexToFrag11_g75721 = Gradient_Tint2784_g75662;
				outputPackedVaryingsMeshToPS.ase_texcoord6.x = vertexToFrag11_g75721;
				outputPackedVaryingsMeshToPS.ase_texcoord6.yzw = vertexToFrag3890_g75662;
						...
						)
			{
				...
				float vertexToFrag11_g75721 = packedInput.ase_texcoord6.x;
				float3 lerpResult2779_g75662 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g75721);
				...
				float temp_output_7_0_g75760 = _MainMaskMinValue;
				half Main_Mask_Remap5765_g75662 = saturate( ( ( clampResult5814_g75662 - temp_output_7_0_g75760 ) / ( _MainMaskMaxValue - temp_output_7_0_g75760 ) ) );
				half Blend_Mask_Invert6260_g75662 = ( 1.0 - 0.0 );
				half Gradient_Mask6207_g75662 = ( Main_Mask_Remap5765_g75662 * Blend_Mask_Invert6260_g75662 );
				...
				half Vertex_Occlusion648_g75662 = 1.0;
				half3 Blend_Albedo_Tinted2808_g75662 = ( Blend_Albedo265_g75662 * Blend_Albedo_Gradient5769_g75662 * Blend_Albedo_Noise5770_g75662 * Vertex_Occlusion648_g75662 );
				...
				float4 temp_output_91_19_g75680 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g75662 = packedInput.ase_texcoord6.yzw;
				float3 WorldPosition3905_g75662 = vertexToFrag3890_g75662;
				...
				half2 UV94_g75680 = ( (temp_output_91_19_g75680).zw + ( (temp_output_91_19_g75680).xy * (lerpResult4822_g75662).xz ) );
				float temp_output_82_0_g75680 = _LayerColorsValue;
				float4 lerpResult108_g75680 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g75680,temp_output_82_0_g75680, 0.0 ) , TVE_ColorsUsage[(int)temp_output_82_0_g75680]);
				half4 Global_Colors_Params5434_g75662 = lerpResult108_g75680;
				float4 temp_output_346_0_g75763 = Global_Colors_Params5434_g75662;
				half Global_Colors_A1701_g75662 = saturate( (temp_output_346_0_g75763).w );
				...
				half3 Global_Colors_RGB1700_g75662 = (temp_output_346_0_g75763).xyz;
				half3 Colors_RGB1954_g75662 = ( Global_Colors_RGB1700_g75662 * 4.594794 );
				half Colors_Value3692_g75662 = ( ( Main_Mask_Remap5765_g75662 * Blend_Mask_Invert6260_g75662 ) * _GlobalColors );
				half Colors_Variation3650_g75662 = 1.0;
				half Mesh_Height1524_g75662 = packedInput.ase_color.a;
				float lerpResult6100_g75662 = lerp( saturate( ( Blend_Albedo_Grayscale5939_g75662 * 5.0 ) ) , ( 1.0 - Mesh_Height1524_g75662 ) , _ColorsMaskMode);
				float temp_output_7_0_g75762 = 0.1;
				float lerpResult16_g75712 = lerp( 0.0 , saturate( ( ( ( Colors_Value3692_g75662 * Colors_Influence3668_g75662 * Colors_Variation3650_g75662 * 2.0 * lerpResult6100_g75662 ) - temp_output_7_0_g75762 ) / ( 0.2 - temp_output_7_0_g75762 ) ) ) , TVE_Enabled);
				float3 lerpResult3628_g75662 = lerp( Blend_Albedo_Tinted2808_g75662 , ( lerpResult3618_g75662 * Colors_RGB1954_g75662 ) , lerpResult16_g75712);
				...
				half3 Blend_Albedo_Highlight5771_g75662 = float3(1,1,1);
				half3 Subsurface_Color1722_g75662 = ( (_SubsurfaceColor).rgb * Blend_Albedo_Colored863_g75662 * Blend_Albedo_Highlight5771_g75662 );
				half Global_Subsurface4041_g75662 = TVE_SubsurfaceValue;
				float4 temp_output_93_19_g75676 = TVE_ExtrasCoords;
				float3 lerpResult4827_g75662 = lerp( WorldPosition3905_g75662 , ObjectPosition4223_g75662 , _ExtrasPositionMode);
				half2 UV96_g75676 = ( (temp_output_93_19_g75676).zw + ( (temp_output_93_19_g75676).xy * (lerpResult4827_g75662).xz ) );
				float temp_output_84_0_g75676 = _LayerExtrasValue;
				float4 lerpResult109_g75676 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g75676,temp_output_84_0_g75676, 0.0 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g75676]);
				half4 Global_Extras_Params5440_g75662 = lerpResult109_g75676;
				float4 break456_g75669 = Global_Extras_Params5440_g75662;
				half Global_Extras_Overlay156_g75662 = break456_g75669.z;
				half Overlay_Value5738_g75662 = ( _GlobalOverlay * Global_Extras_Overlay156_g75662 );
				half Subsurface_Intensity1752_g75662 = ( _SubsurfaceValue * Global_Subsurface4041_g75662 * ( 1.0 - Overlay_Value5738_g75662 ) );
				half Subsurface_Mask1557_g75662 = ( Main_Mask_Remap5765_g75662 * Blend_Mask_Invert6260_g75662 );
				...
				half3 Blend_Albedo_Subsurface149_g75662 = ( Blend_Albedo_Colored863_g75662 + Subsurface_Approximation1693_g75662 );
				...
				float temp_output_7_0_g75714 = 0.1;
				half Global_OverlayHeightStart5667_g75662 = TVE_OverlayHeightStart;
				float temp_output_7_0_g75710 = Global_OverlayHeightStart5667_g75662;
				half Global_OverlayHeightEnd5668_g75662 = TVE_OverlayHeightEnd;
				half Overlay_Height5651_g75662 = saturate( ( ( (WorldPosition3905_g75662).y - temp_output_7_0_g75710 ) / ( Global_OverlayHeightEnd5668_g75662 - temp_output_7_0_g75710 ) ) );
				half Overlay_Mask_High6064_g75662 = ( saturate( ( ( ( Overlay_Value5738_g75662 * Overlay_Projection6081_g75662 * Overlay_Variation4560_g75662 * saturate( ( Blend_Albedo_Grayscale5939_g75662 * 5.0 ) ) ) - temp_output_7_0_g75714 ) / ( 0.3 - temp_output_7_0_g75714 ) ) ) * Overlay_Height5651_g75662 );
				half Overlay_Mask269_g75662 = Overlay_Mask_High6064_g75662;
				float3 lerpResult336_g75662 = lerp( Blend_Albedo_Subsurface149_g75662 , Global_OverlayColor1758_g75662 , Overlay_Mask269_g75662);
				half3 Final_Albedo359_g75662 = lerpResult336_g75662;
				
				float3 unpack4112_g75662 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MainNormalTex, sampler_Linear_Repeat, Main_UVs15_g75662 ), _MainNormalValue );
				unpack4112_g75662.z = lerp( 1, unpack4112_g75662.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g75662 = unpack4112_g75662;
				float3 temp_output_13_0_g75718 = Main_Normal137_g75662;
				float3 switchResult12_g75718 = (((isFrontFace>0)?(temp_output_13_0_g75718):(( temp_output_13_0_g75718 * _render_normals ))));
				half3 Blend_Normal312_g75662 = switchResult12_g75718;
				half3 Final_Normal366_g75662 = Blend_Normal312_g75662;
				...
				half Global_Extras_Emissive4203_g75662 = break456_g75669.x;
				...
				half Final_Smoothness371_g75662 = lerpResult343_g75662;
				half Global_Extras_Wetness305_g75662 = break456_g75669.y;
				float lerpResult3673_g75662 = lerp( 0.0 , Global_Extras_Wetness305_g75662 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g75662 = saturate( ( Final_Smoothness371_g75662 + lerpResult3673_g75662 ) );
				...
				float localCustomAlphaClip19_g75759 = ( 0.0 );
				...
				half Fade_Always6228_g75662 = ( 1.0 * ( 1.0 - _FadeConstantValue ) );
				...
				float lerpResult3992_g75662 = lerp( 1.0 , saturate( abs( dotResult2161_g75662 ) ) , lerpResult2221_g75662);
				half Fade_Billboard2175_g75662 = lerpResult3992_g75662;
				half Fade_Mask5149_g75662 = ( 1.0 * Blend_Mask_Invert6260_g75662 );
				float lerpResult5141_g75662 = lerp( 1.0 , ( 1.0 * Fade_Billboard2175_g75662 ) , Fade_Mask5149_g75662);
				half Fade_Effects5360_g75662 = lerpResult5141_g75662;
				float4 tex3DNode27_g75756 = SAMPLE_TEXTURE3D( TVE_ScreenTex3D, sampler_Linear_Repeat, ( TVE_ScreenTexCoord * WorldPosition3905_g75662 ) );
				half AlphaTreshold2132_g75662 = _AlphaClipValue;
				float temp_output_5865_0_g75662 = saturate( ( ( ( Fade_Always6228_g75662 * Fade_Effects5360_g75662 ) - tex3DNode27_g75756.r ) + ( ( Fade_Always6228_g75662 * Fade_Effects5360_g75662 ) * 0.5 ) + AlphaTreshold2132_g75662 ) );
				half Fade_Alpha3727_g75662 = temp_output_5865_0_g75662;
				float temp_output_661_0_g75662 = ( Blend_Alpha6157_g75662 * Global_Alpha315_g75662 * Fade_Alpha3727_g75662 );
				half Alpha34_g75758 = temp_output_661_0_g75662;
				float temp_output_3_0_g75759 = Alpha34_g75758;
				float Alpha19_g75759 = temp_output_3_0_g75759;
				float temp_output_15_0_g75759 = AlphaTreshold2132_g75662;
				float Treshold19_g75759 = temp_output_15_0_g75759;
				{
				#if defined (TVE_FEATURE_CLIP)
				#if defined (TVE_IS_HD_PIPELINE)
				#if !defined (SHADERPASS_FORWARD_BYPASS_ALPHA_TEST)
				clip(Alpha19_g75759 - Treshold19_g75759);
				#endif
				...
				half Final_Alpha914_g75662 = saturate( ( Alpha19_g75759 * Blend_Color_Alpha6167_g75662 ) );
				
				half Subsurface_Thickness1276_g75662 = ( 1.0 - ( Subsurface_Intensity1752_g75662 * Subsurface_Mask1557_g75662 ) );
				
				surfaceDescription.BaseColor = Final_Albedo359_g75662;
				surfaceDescription.Normal = Final_Normal366_g75662;
				...
				surfaceDescription.Smoothness = Final_SmoothnessAndWetness4130_g75662;
				...
				surfaceDescription.Thickness = Subsurface_Thickness1276_g75662;
				#endif
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				half Input_MotionVariation284_g75726 = _MotionVariation_10;
				float3 localObjectPosition_UNITY_MATRIX_M14_g75695 = ObjectPosition_UNITY_MATRIX_M();
				float3 appendResult60_g75701 = (float3(inputMesh.uv3.x , inputMesh.uv3.z , inputMesh.uv3.y));
				half3 Mesh_PivotsData2831_g75662 = ( appendResult60_g75701 * _VertexPivotMode );
				float3 temp_output_122_0_g75695 = Mesh_PivotsData2831_g75662;
				float3 PivotsOnly105_g75695 = (mul( GetObjectToWorldMatrix(), float4( temp_output_122_0_g75695 , 0.0 ) ).xyz).xyz;
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				...
				half Input_MeshHeight388_g75735 = Mesh_Height1524_g75662;
				half ObjectData20_g75736 = ( Input_MeshHeight388_g75735 * 2.0 );
				float enc62_g75703 = inputMesh.uv0.w;
				float2 localDecodeFloatToVector262_g75703 = DecodeFloatToVector2( enc62_g75703 );
				float2 break63_g75703 = ( localDecodeFloatToVector262_g75703 * 100.0 );
				float Bounds_Height5230_g75662 = break63_g75703.x;
				half Input_BoundsHeight390_g75735 = Bounds_Height5230_g75662;
				...
				half Gradient_Tint2784_g75662 = saturate( ( ( Mesh_Height1524_g75662 - temp_output_7_0_g75724 ) / ( _GradientMaxValue - temp_output_7_0_g75724 ) ) );
				float vertexToFrag11_g75721 = Gradient_Tint2784_g75662;
				outputPackedVaryingsMeshToPS.ase_texcoord3.x = vertexToFrag11_g75721;
				outputPackedVaryingsMeshToPS.ase_texcoord3.yzw = vertexToFrag3890_g75662;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half3 Main_Albedo99_g75662 = ( (_MainColor).rgb * lerpResult6223_g75662 );
				half3 Blend_Albedo265_g75662 = Main_Albedo99_g75662;
				float vertexToFrag11_g75721 = packedInput.ase_texcoord3.x;
				float3 lerpResult2779_g75662 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g75721);
				float4 tex2DNode35_g75662 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g75662 );
				half Main_Mask57_g75662 = tex2DNode35_g75662.b;
				float clampResult5814_g75662 = clamp( Main_Mask57_g75662 , 0.01 , 0.99 );
				...
				float3 temp_cast_0 = (Blend_Albedo_Grayscale5939_g75662).xxx;
				float4 temp_output_91_19_g75680 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g75662 = packedInput.ase_texcoord3.yzw;
				float3 WorldPosition3905_g75662 = vertexToFrag3890_g75662;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				half Gradient_Tint2784_g75662 = saturate( ( ( Mesh_Height1524_g75662 - temp_output_7_0_g75724 ) / ( _GradientMaxValue - temp_output_7_0_g75724 ) ) );
				float vertexToFrag11_g75721 = Gradient_Tint2784_g75662;
				outputPackedVaryingsMeshToPS.ase_texcoord4.w = vertexToFrag11_g75721;
					...
					)
			{
				...
				half3 Main_Albedo99_g75662 = ( (_MainColor).rgb * lerpResult6223_g75662 );
				half3 Blend_Albedo265_g75662 = Main_Albedo99_g75662;
				float vertexToFrag11_g75721 = packedInput.ase_texcoord4.w;
				float3 lerpResult2779_g75662 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g75721);
				half Main_Mask57_g75662 = tex2DNode35_g75662.b;
				float clampResult5814_g75662 = clamp( Main_Mask57_g75662 , 0.01 , 0.99 );
				float temp_output_7_0_g75760 = _MainMaskMinValue;
		...
		Pass
		{
				...
				)
			{
				...
				half3 Main_Normal137_g75662 = unpack4112_g75662;
				float3 temp_output_13_0_g75718 = Main_Normal137_g75662;
				float3 switchResult12_g75718 = (((ase_vface>0)?(temp_output_13_0_g75718):(( temp_output_13_0_g75718 * _render_normals ))));
				half3 Blend_Normal312_g75662 = switchResult12_g75718;
				half3 Final_Normal366_g75662 = Blend_Normal312_g75662;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				half Gradient_Tint2784_g75662 = saturate( ( ( Mesh_Height1524_g75662 - temp_output_7_0_g75724 ) / ( _GradientMaxValue - temp_output_7_0_g75724 ) ) );
				float vertexToFrag11_g75721 = Gradient_Tint2784_g75662;
				outputPackedVaryingsMeshToPS.ase_texcoord8.x = vertexToFrag11_g75721;
				outputPackedVaryingsMeshToPS.ase_texcoord8.yzw = vertexToFrag3890_g75662;
						...
						)
			{
				...
				half3 Main_Albedo99_g75662 = ( (_MainColor).rgb * lerpResult6223_g75662 );
				half3 Blend_Albedo265_g75662 = Main_Albedo99_g75662;
				float vertexToFrag11_g75721 = packedInput.ase_texcoord8.x;
				float3 lerpResult2779_g75662 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g75721);
				float4 tex2DNode35_g75662 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g75662 );
				half Main_Mask57_g75662 = tex2DNode35_g75662.b;
				float clampResult5814_g75662 = clamp( Main_Mask57_g75662 , 0.01 , 0.99 );
				...
				float3 temp_cast_0 = (Blend_Albedo_Grayscale5939_g75662).xxx;
				float4 temp_output_91_19_g75680 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g75662 = packedInput.ase_texcoord8.yzw;
				float3 WorldPosition3905_g75662 = vertexToFrag3890_g75662;
...
Node;AmplifyShaderEditor.FunctionNode;406;-1536,-896;Inherit;False;Compile Core;-1;;74138;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;371;-1984,-896;Half;False;Property;_IsSubsurfaceShader;_IsSubsurfaceShader;199;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;354;-2176,384;Inherit;False;Define Shader Vegetation;-1;;75659;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;404;-1856,384;Inherit;False;Define Pipeline HD;-1;;75660;7af1bc24c286d754db63fb6a44aba77b;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.RangedFloatNode;374;-1408,-768;Half;False;Property;_subsurface_shadow;_subsurface_shadow;198;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;405;-1344,-896;Inherit;False;Compile All Shaders;-1;;75661;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;81;-2176,-896;Half;False;Property;_IsCrossShader;_IsCrossShader;200;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;370;-2176,-384;Inherit;False;Base Shader;0;;75662;856f7164d1c579d43a5cf4968a75ca43;79,3880,1,4028,1,3900,1,3908,1,4172,1,1300,1,1298,1,4179,1,4995,1,3586,0,4499,1,1708,1,6056,1,3509,1,3873,0,893,0,6230,0,5156,1,5345,0,6116,1,1718,1,1717,1,1715,1,1714,1,5075,1,1763,0,6068,1,6076,1,1776,0,3475,1,4210,1,1745,1,3479,0,3501,1,1646,1,1271,0,2807,1,6206,1,3886,0,4999,0,6194,0,3887,0,3957,1,6257,0,5357,0,2172,0,3883,1,3728,0,3949,0,5350,0,2658,0,1742,0,3484,0,4837,0,1733,0,1735,0,1737,0,1736,0,6166,0,5079,0,6161,0,1734,0,6138,0,878,0,1550,0,860,1,2260,1,2261,1,2032,0,2054,0,5258,0,2039,0,2062,0,3243,0,5220,0,4217,1,4242,0,5090,1,5339,0;7;6196;FLOAT;1;False;6198;FLOAT;1;False;6201;FLOAT;1;False;6205;FLOAT;1;False;5143;FLOAT;1;False;6231;FLOAT;1;False;5340;FLOAT3;0,0,0;False;23;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4842;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT;532;FLOAT;5389;FLOAT;721;FLOAT3;1230;FLOAT;5296;FLOAT;1461;FLOAT;1290;FLOAT;629;FLOAT3;534;FLOAT;4867;FLOAT4;5246;FLOAT4;4841
...
WireConnection;393;62;370;1290
WireConnection;393;11;370;534
ASEEND*/
//CHKSM=F76938052BB1154685E875FA4F435A4296A97FFC
