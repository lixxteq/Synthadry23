	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 appendResult60_g78052 = (float3(inputMesh.ase_texcoord3.x , inputMesh.ase_texcoord3.z , inputMesh.ase_texcoord3.y));
				half3 Mesh_PivotsData2831_g78013 = ( appendResult60_g78052 * _VertexPivotMode );
				...
				half3 Input_Position419_g78077 = WorldPosition3905_g78013;
				float Input_MotionScale287_g78077 = ( _MotionScale_10 + 0.2 );
				half Global_NoiseScale448_g78077 = TVE_NoiseParams.x;
				float2 temp_output_597_0_g78077 = (( Input_Position419_g78077 * Input_MotionScale287_g78077 * Global_NoiseScale448_g78077 * 0.0075 )).xz;
				float2 temp_output_447_0_g78058 = ((TVE_MotionParams).xy*2.0 + -1.0);
				half2 Global_Wind_DirectionWS4683_g78013 = temp_output_447_0_g78058;
				half2 Input_DirectionWS423_g78077 = Global_Wind_DirectionWS4683_g78013;
				half Input_MotionSpeed62_g78077 = _MotionSpeed_10;
				half Global_NoiseSpeed449_g78077 = TVE_NoiseParams.y;
				half Input_MotionVariation284_g78077 = _MotionVariation_10;
				float3 localObjectPosition_UNITY_MATRIX_M14_g78046 = ObjectPosition_UNITY_MATRIX_M();
				float3 temp_output_122_0_g78046 = Mesh_PivotsData2831_g78013;
				float3 PivotsOnly105_g78046 = (mul( GetObjectToWorldMatrix(), float4( temp_output_122_0_g78046 , 0.0 ) ).xyz).xyz;
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g78046 = ( ( localObjectPosition_UNITY_MATRIX_M14_g78046 + PivotsOnly105_g78046 ) + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g78046 = ( localObjectPosition_UNITY_MATRIX_M14_g78046 + PivotsOnly105_g78046 );
				#endif
				half3 ObjectData20_g78047 = staticSwitch13_g78046;
				half3 WorldData19_g78047 = ase_worldPos;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g78047 = WorldData19_g78047;
				#else
				float3 staticSwitch14_g78047 = ObjectData20_g78047;
				#endif
				float3 temp_output_114_0_g78046 = staticSwitch14_g78047;
				float3 vertexToFrag4224_g78013 = temp_output_114_0_g78046;
				half3 ObjectData20_g78043 = vertexToFrag4224_g78013;
				half3 WorldData19_g78043 = vertexToFrag3890_g78013;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g78043 = WorldData19_g78043;
				#else
				float3 staticSwitch14_g78043 = ObjectData20_g78043;
				#endif
				float3 ObjectPosition4223_g78013 = staticSwitch14_g78043;
				float3 break111_g78099 = ObjectPosition4223_g78013;
				half Global_DynamicMode5112_g78013 = _VertexDynamicMode;
				half Input_DynamicMode120_g78099 = Global_DynamicMode5112_g78013;
				float Postion_Sum142_g78099 = ( ( break111_g78099.x + break111_g78099.y + break111_g78099.z + 0.001275 ) * ( 1.0 - Input_DynamicMode120_g78099 ) );
				float Mesh_Variation16_g78013 = inputMesh.ase_color.r;
				half Input_Variation124_g78099 = Mesh_Variation16_g78013;
				half ObjectData20_g78101 = ( Postion_Sum142_g78099 + Input_Variation124_g78099 );
				half WorldData19_g78101 = Input_Variation124_g78099;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g78101 = WorldData19_g78101;
				#else
				float staticSwitch14_g78101 = ObjectData20_g78101;
				#endif
				float clampResult129_g78099 = clamp( frac( staticSwitch14_g78101 ) , 0.01 , 0.99 );
				float Global_MeshVariation5104_g78013 = clampResult129_g78099;
				half Input_GlobalMeshVariation569_g78077 = Global_MeshVariation5104_g78013;
				half Input_ObjectVariation694_g78077 = _MotionObjectVariation;
				half ObjectData20_g78102 = Postion_Sum142_g78099;
				half WorldData19_g78102 = 0.0;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g78102 = WorldData19_g78102;
				#else
				float staticSwitch14_g78102 = ObjectData20_g78102;
				#endif
				float Global_ObjectVariation6217_g78013 = staticSwitch14_g78102;
				half Input_GlobalObjectVariation692_g78077 = Global_ObjectVariation6217_g78013;
				float temp_output_630_0_g78077 = ( ( ( _TimeParameters.x * Input_MotionSpeed62_g78077 * Global_NoiseSpeed449_g78077 ) + ( Input_MotionVariation284_g78077 * Input_GlobalMeshVariation569_g78077 ) + ( Input_ObjectVariation694_g78077 * Input_GlobalObjectVariation692_g78077 ) ) * 0.03 );
				float temp_output_607_0_g78077 = frac( temp_output_630_0_g78077 );
				float4 lerpResult590_g78077 = lerp( SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( temp_output_597_0_g78077 + ( -Input_DirectionWS423_g78077 * temp_output_607_0_g78077 ) ), 0.0 ) , SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( temp_output_597_0_g78077 + ( -Input_DirectionWS423_g78077 * frac( ( temp_output_630_0_g78077 + 0.5 ) ) ) ), 0.0 ) , ( abs( ( temp_output_607_0_g78077 - 0.5 ) ) / 0.5 ));
				float2 temp_output_645_0_g78077 = ((lerpResult590_g78077).rg*2.0 + -1.0);
				float2 break650_g78077 = temp_output_645_0_g78077;
				float3 appendResult649_g78077 = (float3(break650_g78077.x , 0.0 , break650_g78077.y));
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				half2 Global_Noise_OS5548_g78013 = (( mul( GetWorldToObjectMatrix(), float4( appendResult649_g78077 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Noise_DirectionOS487_g78086 = Global_Noise_OS5548_g78013;
				float2 break448_g78058 = temp_output_447_0_g78058;
				float3 appendResult452_g78058 = (float3(break448_g78058.x , 0.0 , break448_g78058.y));
				half2 Global_Wind_DirectionOS5692_g78013 = (( mul( GetWorldToObjectMatrix(), float4( appendResult452_g78058 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_Wind_DirectionOS458_g78086 = Global_Wind_DirectionOS5692_g78013;
				float4 temp_output_91_19_g78035 = TVE_MotionCoords;
				half2 UV94_g78035 = ( (temp_output_91_19_g78035).zw + ( (temp_output_91_19_g78035).xy * (ObjectPosition4223_g78013).xz ) );
				float temp_output_84_0_g78035 = _LayerMotionValue;
				float4 lerpResult107_g78035 = lerp( TVE_MotionParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_MotionTex, sampler_Linear_Clamp, UV94_g78035,temp_output_84_0_g78035, 0.0 ) , TVE_MotionUsage[(int)temp_output_84_0_g78035]);
				half4 Global_Motion_Params3909_g78013 = lerpResult107_g78035;
				float4 break322_g78058 = Global_Motion_Params3909_g78013;
				half Global_Wind_Power2223_g78013 = break322_g78058.z;
				half Input_WindPower449_g78086 = Global_Wind_Power2223_g78013;
				float temp_output_565_0_g78086 = ( 1.0 - Input_WindPower449_g78086 );
				float2 lerpResult516_g78086 = lerp( Input_Noise_DirectionOS487_g78086 , Input_Wind_DirectionOS458_g78086 , ( ( 1.0 - ( temp_output_565_0_g78086 * temp_output_565_0_g78086 * temp_output_565_0_g78086 ) ) * 0.6 ));
				half Mesh_Height1524_g78013 = inputMesh.ase_color.a;
				half Input_MeshHeight388_g78086 = Mesh_Height1524_g78013;
				half ObjectData20_g78087 = ( Input_MeshHeight388_g78086 * 2.0 );
				float enc62_g78054 = inputMesh.ase_texcoord.w;
				float2 localDecodeFloatToVector262_g78054 = DecodeFloatToVector2( enc62_g78054 );
				float2 break63_g78054 = ( localDecodeFloatToVector262_g78054 * 100.0 );
				float Bounds_Height5230_g78013 = break63_g78054.x;
				half Input_BoundsHeight390_g78086 = Bounds_Height5230_g78013;
				half WorldData19_g78087 = ( ( Input_MeshHeight388_g78086 * Input_MeshHeight388_g78086 ) * Input_BoundsHeight390_g78086 * 2.0 );
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g78087 = WorldData19_g78087;
				#else
				float staticSwitch14_g78087 = ObjectData20_g78087;
				#endif
				half Final_Motion_10_Amplitude321_g78086 = staticSwitch14_g78087;
				half Motion_10_Amplitude2258_g78013 = _MotionAmplitude_10;
				half Input_BendingAmplitude376_g78086 = Motion_10_Amplitude2258_g78013;
				float2 appendResult433_g78058 = (float2(break322_g78058.x , break322_g78058.y));
				float2 temp_output_436_0_g78058 = (appendResult433_g78058*2.0 + -1.0);
				float2 break441_g78058 = temp_output_436_0_g78058;
				float3 appendResult440_g78058 = (float3(break441_g78058.x , 0.0 , break441_g78058.y));
				half2 Global_React_DirectionOS39_g78013 = (( mul( GetWorldToObjectMatrix(), float4( appendResult440_g78058 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half2 Input_React_DirectionOS358_g78086 = Global_React_DirectionOS39_g78013;
				half Input_InteractionAmplitude58_g78086 = _InteractionAmplitude;
				half Input_InteractionUseMask62_g78086 = _InteractionMaskValue;
				float lerpResult371_g78086 = lerp( 2.0 , Final_Motion_10_Amplitude321_g78086 , Input_InteractionUseMask62_g78086);
				half ObjectData20_g78088 = lerpResult371_g78086;
				half WorldData19_g78088 = Final_Motion_10_Amplitude321_g78086;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g78088 = WorldData19_g78088;
				#else
				float staticSwitch14_g78088 = ObjectData20_g78088;
				#endif
				half Final_InteractionAmplitude373_g78086 = ( Input_InteractionAmplitude58_g78086 * staticSwitch14_g78088 );
				half Global_Interaction_Mask66_g78013 = ( break322_g78058.w * break322_g78058.w * break322_g78058.w * break322_g78058.w );
				float Input_InteractionGlobalMask330_g78086 = Global_Interaction_Mask66_g78013;
				half Final_InteractionMask525_g78086 = saturate( ( Input_InteractionAmplitude58_g78086 * Input_InteractionGlobalMask330_g78086 ) );
				float2 lerpResult551_g78086 = lerp( ( lerpResult516_g78086 * ( Final_Motion_10_Amplitude321_g78086 * Input_BendingAmplitude376_g78086 * ( Input_WindPower449_g78086 * Input_WindPower449_g78086 ) ) ) , ( Input_React_DirectionOS358_g78086 * Final_InteractionAmplitude373_g78086 ) , Final_InteractionMask525_g78086);
				float2 break364_g78086 = lerpResult551_g78086;
				half Motion_10_BendingZ190_g78013 = break364_g78086.y;
				half Angle44_g78015 = Motion_10_BendingZ190_g78013;
				half3 VertexPos40_g78023 = ( VertexPosRotationAxis50_g78015 + ( VertexPosOtherAxis82_g78015 * cos( Angle44_g78015 ) ) + ( cross( float3(1,0,0) , VertexPosOtherAxis82_g78015 ) * sin( Angle44_g78015 ) ) );
				float3 appendResult74_g78023 = (float3(0.0 , 0.0 , VertexPos40_g78023.z));
				half3 VertexPosRotationAxis50_g78023 = appendResult74_g78023;
				float3 break84_g78023 = VertexPos40_g78023;
				float3 appendResult81_g78023 = (float3(break84_g78023.x , break84_g78023.y , 0.0));
				half3 VertexPosOtherAxis82_g78023 = appendResult81_g78023;
				half Motion_10_BendingX216_g78013 = break364_g78086.x;
				half Angle44_g78023 = -Motion_10_BendingX216_g78013;
				float Sum_Position446_g78096 = ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z );
				half Input_MotionScale321_g78096 = ( _MotionScale_20 * 0.1 );
				half Input_MotionVariation330_g78096 = _MotionVariation_20;
				half Input_GlobalVariation400_g78096 = Global_MeshVariation5104_g78013;
				half Input_MotionSpeed62_g78096 = _MotionSpeed_20;
				float temp_output_404_0_g78096 = ( _TimeParameters.x * Input_MotionSpeed62_g78096 );
				half Motion_20_SineA450_g78096 = sin( ( ( Sum_Position446_g78096 * Input_MotionScale321_g78096 ) + ( Input_MotionVariation330_g78096 * Input_GlobalVariation400_g78096 ) + temp_output_404_0_g78096 ) );
				half Motion_20_SineB395_g78096 = sin( ( ( temp_output_404_0_g78096 * 0.7562 ) + ( Sum_Position446_g78096 * Input_MotionScale321_g78096 ) ) );
				half3 Input_Position419_g78084 = VertexPosition3588_g78013;
				float3 normalizeResult518_g78084 = normalize( Input_Position419_g78084 );
				half2 Input_DirectionOS423_g78084 = Global_React_DirectionOS39_g78013;
				float2 break521_g78084 = -Input_DirectionOS423_g78084;
				float3 appendResult522_g78084 = (float3(break521_g78084.x , 0.0 , break521_g78084.y));
				float dotResult519_g78084 = dot( normalizeResult518_g78084 , appendResult522_g78084 );
				half Input_Mask62_g78084 = _MotionFacingValue;
				float lerpResult524_g78084 = lerp( 1.0 , (dotResult519_g78084*0.5 + 0.5) , Input_Mask62_g78084);
				half ObjectData20_g78085 = max( lerpResult524_g78084 , 0.001 );
				half WorldData19_g78085 = 1.0;
				#ifdef TVE_FEATURE_BATCHING
				float staticSwitch14_g78085 = WorldData19_g78085;
				#else
				float staticSwitch14_g78085 = ObjectData20_g78085;
				#endif
				half Motion_FacingMask5214_g78013 = staticSwitch14_g78085;
				half Motion_20_Amplitude4381_g78013 = ( _MotionValue_20 * Motion_FacingMask5214_g78013 );
				half Input_MotionAmplitude384_g78096 = Motion_20_Amplitude4381_g78013;
				half Input_GlobalWind407_g78096 = Global_Wind_Power2223_g78013;
				float4 break638_g78077 = abs( lerpResult590_g78077 );
				half Global_Noise_B5526_g78013 = break638_g78077.b;
				half Input_GlobalNoise411_g78096 = Global_Noise_B5526_g78013;
				float lerpResult413_g78096 = lerp( 1.4 , 0.4 , Input_GlobalWind407_g78096);
				half Final_MotionAmplitude418_g78096 = ( Input_MotionAmplitude384_g78096 * Input_GlobalWind407_g78096 * pow( Input_GlobalNoise411_g78096 , lerpResult413_g78096 ) );
				half Input_Squash58_g78096 = _MotionAmplitude_20;
				float enc59_g78054 = inputMesh.ase_texcoord.z;
				float2 localDecodeFloatToVector259_g78054 = DecodeFloatToVector2( enc59_g78054 );
				float2 break61_g78054 = localDecodeFloatToVector259_g78054;
				half Mesh_Motion_2060_g78013 = break61_g78054.x;
				half Input_MeshMotion_20388_g78096 = Mesh_Motion_2060_g78013;
				float Bounds_Radius5231_g78013 = break63_g78054.y;
				half Input_BoundsRadius390_g78096 = Bounds_Radius5231_g78013;
				half2 Input_DirectionOS366_g78096 = Global_React_DirectionOS39_g78013;
				float2 break371_g78096 = Input_DirectionOS366_g78096;
				float3 appendResult372_g78096 = (float3(break371_g78096.x , ( Motion_20_SineA450_g78096 * 0.1 ) , break371_g78096.y));
				half3 Motion_20_Squash4418_g78013 = ( ( (max( Motion_20_SineA450_g78096 , Motion_20_SineB395_g78096 )*0.2 + 1.0) * Final_MotionAmplitude418_g78096 * Input_Squash58_g78096 * Input_MeshMotion_20388_g78096 * Input_BoundsRadius390_g78096 ) * appendResult372_g78096 );
				half3 VertexPos40_g78014 = ( ( VertexPosRotationAxis50_g78023 + ( VertexPosOtherAxis82_g78023 * cos( Angle44_g78023 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g78023 ) * sin( Angle44_g78023 ) ) ) + Motion_20_Squash4418_g78013 );
				...
				half Input_Rolling379_g78096 = _MotionAmplitude_22;
				half Motion_20_Rolling5257_g78013 = ( Motion_20_SineA450_g78096 * Final_MotionAmplitude418_g78096 * Input_Rolling379_g78096 * Input_MeshMotion_20388_g78096 );
				half Angle44_g78014 = Motion_20_Rolling5257_g78013;
				float2 appendResult461_g78089 = (float2(ase_worldPos.x , ase_worldPos.z));
				half Input_MotionScale321_g78089 = _MotionScale_32;
				half Input_MotionVariation330_g78089 = _MotionVariation_32;
				half Input_GlobalVariation372_g78089 = Global_MeshVariation5104_g78013;
				half Input_MotionSpeed62_g78089 = _MotionSpeed_32;
				half Global_Speed350_g78089 = TVE_FlutterParams.y;
				float4 tex2DNode460_g78089 = SAMPLE_TEXTURE2D_LOD( TVE_NoiseTex, sampler_Linear_Repeat, ( ( appendResult461_g78089 * Input_MotionScale321_g78089 * 0.03 ) + ( Input_MotionVariation330_g78089 * Input_GlobalVariation372_g78089 ) + ( _TimeParameters.x * Input_MotionSpeed62_g78089 * Global_Speed350_g78089 * 0.02 ) ), 0.0 );
				float3 appendResult462_g78089 = (float3(tex2DNode460_g78089.r , tex2DNode460_g78089.g , tex2DNode460_g78089.b));
				float temp_output_7_0_g78045 = TVE_MotionFadeEnd;
				half Motion_FadeOut4005_g78013 = saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g78045 ) / ( TVE_MotionFadeStart - temp_output_7_0_g78045 ) ) );
				...
				half Input_MotionAmplitude58_g78089 = Motion_30_Amplitude4960_g78013;
				half Global_Power354_g78089 = TVE_FlutterParams.x;
				half Mesh_Motion_30144_g78013 = break61_g78054.y;
				half Input_MeshMotion_30374_g78089 = Mesh_Motion_30144_g78013;
				half Input_GlobalWind471_g78089 = Global_Wind_Power2223_g78013;
				half Input_GlobalNoise472_g78089 = Global_Noise_B5526_g78013;
				float lerpResult466_g78089 = lerp( 2.0 , 0.6 , Input_GlobalWind471_g78089);
				half3 Motion_30_Details263_g78013 = ( (appendResult462_g78089*2.0 + -1.0) * Input_MotionAmplitude58_g78089 * Global_Power354_g78089 * Input_MeshMotion_30374_g78089 * Input_GlobalWind471_g78089 * pow( Input_GlobalNoise472_g78089 , lerpResult466_g78089 ) );
				...
				float4 temp_output_94_19_g78039 = TVE_VertexCoords;
				half2 UV97_g78039 = ( (temp_output_94_19_g78039).zw + ( (temp_output_94_19_g78039).xy * (ObjectPosition4223_g78013).xz ) );
				float temp_output_84_0_g78039 = _LayerVertexValue;
				float4 lerpResult109_g78039 = lerp( TVE_VertexParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_VertexTex, sampler_Linear_Clamp, UV97_g78039,temp_output_84_0_g78039, 0.0 ) , TVE_VertexUsage[(int)temp_output_84_0_g78039]);
				half4 Global_Vertex_Params4173_g78013 = lerpResult109_g78039;
				...
				half3 ObjectData20_g78025 = appendResult3480_g78013;
				half3 _Vector11 = half3(1,1,1);
				half3 WorldData19_g78025 = _Vector11;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g78025 = WorldData19_g78025;
				#else
				float3 staticSwitch14_g78025 = ObjectData20_g78025;
				#endif
				half3 Vertex_Size1741_g78013 = staticSwitch14_g78025;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g78013 = _Vector5;
				float3 lerpResult16_g78024 = lerp( VertexPosition3588_g78013 , ( ( ( staticSwitch4976_g78013 + Grass_Perspective2661_g78013 ) * Vertex_Size1741_g78013 * Vertex_SizeFade1740_g78013 ) + Mesh_PivotsOS2291_g78013 ) , TVE_Enabled);
				float3 Final_VertexPosition890_g78013 = ( lerpResult16_g78024 + _DisableSRPBatcher );
				
				float2 appendResult21_g78054 = (float2(inputMesh.uv1.z , inputMesh.uv1.w));
				float2 Mesh_DetailCoord3_g78013 = appendResult21_g78054;
				float2 lerpResult1545_g78013 = lerp( inputMesh.ase_texcoord.xy , Mesh_DetailCoord3_g78013 , _DetailCoordMode);
				float2 vertexToFrag11_g78021 = ( ( lerpResult1545_g78013 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord6.xy = vertexToFrag11_g78021;
				half Mesh_DetailMask90_g78013 = inputMesh.ase_color.b;
				float vertexToFrag11_g78066 = Mesh_DetailMask90_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord6.z = vertexToFrag11_g78066;
				float temp_output_7_0_g78075 = _GradientMinValue;
				half Gradient_Tint2784_g78013 = saturate( ( ( Mesh_Height1524_g78013 - temp_output_7_0_g78075 ) / ( _GradientMaxValue - temp_output_7_0_g78075 ) ) );
				float vertexToFrag11_g78072 = Gradient_Tint2784_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord6.w = vertexToFrag11_g78072;
				outputPackedVaryingsMeshToPS.ase_texcoord7.xyz = vertexToFrag3890_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = vertexToFrag4224_g78013;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 vertexToFrag5058_g78013 = ase_worldNormal;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag5058_g78013;
				
				float temp_output_7_0_g78103 = TVE_CameraFadeStart;
				float lerpResult4755_g78013 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g78103 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g78103 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g78104 = lerpResult4755_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord7.w = vertexToFrag11_g78104;
						...
						)
			{
				...
				float2 vertexToFrag11_g78021 = packedInput.ase_texcoord6.xy;
				half2 Second_UVs17_g78013 = vertexToFrag11_g78021;
				...
				float vertexToFrag11_g78066 = packedInput.ase_texcoord6.z;
				half Blend_Source1540_g78013 = vertexToFrag11_g78066;
				float clampResult6215_g78013 = clamp( ( lerpResult4058_g78013 * Blend_Source1540_g78013 ) , 0.01 , 0.99 );
				float temp_output_7_0_g78112 = _DetailBlendMinValue;
				half Blend_Mask147_g78013 = ( saturate( ( ( clampResult6215_g78013 - temp_output_7_0_g78112 ) / ( _DetailBlendMaxValue - temp_output_7_0_g78112 ) ) ) * _DetailMode );
				...
				float vertexToFrag11_g78072 = packedInput.ase_texcoord6.w;
				float3 lerpResult2779_g78013 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g78072);
				float clampResult5814_g78013 = clamp( Main_Mask57_g78013 , 0.01 , 0.99 );
				float temp_output_7_0_g78111 = _MainMaskMinValue;
				half Main_Mask_Remap5765_g78013 = saturate( ( ( clampResult5814_g78013 - temp_output_7_0_g78111 ) / ( _MainMaskMaxValue - temp_output_7_0_g78111 ) ) );
				half Blend_Mask_Invert6260_g78013 = ( 1.0 - ( saturate( ( ( clampResult6215_g78013 - temp_output_7_0_g78112 ) / ( _DetailBlendMaxValue - temp_output_7_0_g78112 ) ) ) * _DetailMode ) );
				half Gradient_Mask6207_g78013 = ( Main_Mask_Remap5765_g78013 * Blend_Mask_Invert6260_g78013 );
				...
				float temp_output_7_0_g78068 = _VertexOcclusionMinValue;
				float3 lerpResult2945_g78013 = lerp( (_VertexOcclusionColor).rgb , temp_cast_0 , saturate( ( ( clampResult6091_g78013 - temp_output_7_0_g78068 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g78068 ) ) ));
				half3 Vertex_Occlusion648_g78013 = lerpResult2945_g78013;
				half3 Blend_Albedo_Tinted2808_g78013 = ( Blend_Albedo265_g78013 * Blend_Albedo_Gradient5769_g78013 * Blend_Albedo_Noise5770_g78013 * Vertex_Occlusion648_g78013 );
				...
				float3 temp_cast_1 = (Blend_Albedo_Grayscale5939_g78013).xxx;
				float4 temp_output_91_19_g78031 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g78013 = packedInput.ase_texcoord7.xyz;
				float3 WorldPosition3905_g78013 = vertexToFrag3890_g78013;
				float3 vertexToFrag4224_g78013 = packedInput.ase_texcoord8.xyz;
				half3 ObjectData20_g78043 = vertexToFrag4224_g78013;
				half3 WorldData19_g78043 = vertexToFrag3890_g78013;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g78043 = WorldData19_g78043;
				...
				half2 UV94_g78031 = ( (temp_output_91_19_g78031).zw + ( (temp_output_91_19_g78031).xy * (lerpResult4822_g78013).xz ) );
				float temp_output_82_0_g78031 = _LayerColorsValue;
				float4 lerpResult108_g78031 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, UV94_g78031,temp_output_82_0_g78031, 0.0 ) , TVE_ColorsUsage[(int)temp_output_82_0_g78031]);
				half4 Global_Colors_Params5434_g78013 = lerpResult108_g78031;
				float4 temp_output_346_0_g78114 = Global_Colors_Params5434_g78013;
				half Global_Colors_A1701_g78013 = saturate( (temp_output_346_0_g78114).w );
				...
				float3 lerpResult3618_g78013 = lerp( Blend_Albedo_Tinted2808_g78013 , temp_cast_1 , ( 1.0 - ( temp_output_6306_0_g78013 * temp_output_6306_0_g78013 ) ));
				half3 Global_Colors_RGB1700_g78013 = (temp_output_346_0_g78114).xyz;
				half3 Colors_RGB1954_g78013 = ( Global_Colors_RGB1700_g78013 * 4.594794 );
				half Colors_Value3692_g78013 = ( ( Main_Mask_Remap5765_g78013 * Blend_Mask_Invert6260_g78013 ) * _GlobalColors );
				float3 break111_g78099 = ObjectPosition4223_g78013;
				half Global_DynamicMode5112_g78013 = _VertexDynamicMode;
				half Input_DynamicMode120_g78099 = Global_DynamicMode5112_g78013;
				float Postion_Sum142_g78099 = ( ( break111_g78099.x + break111_g78099.y + break111_g78099.z + 0.001275 ) * ( 1.0 - Input_DynamicMode120_g78099 ) );
				...
				float lerpResult6100_g78013 = lerp( saturate( ( Blend_Albedo_Grayscale5939_g78013 * 5.0 ) ) , ( 1.0 - Mesh_Height1524_g78013 ) , _ColorsMaskMode);
				float temp_output_7_0_g78113 = 0.1;
				float lerpResult16_g78063 = lerp( 0.0 , saturate( ( ( ( Colors_Value3692_g78013 * Colors_Influence3668_g78013 * Colors_Variation3650_g78013 * 2.0 * lerpResult6100_g78013 ) - temp_output_7_0_g78113 ) / ( 0.2 - temp_output_7_0_g78113 ) ) ) , TVE_Enabled);
				float3 lerpResult3628_g78013 = lerp( Blend_Albedo_Tinted2808_g78013 , ( lerpResult3618_g78013 * Colors_RGB1954_g78013 ) , lerpResult16_g78063);
				...
				half3 Blend_Albedo_Highlight5771_g78013 = float3(1,1,1);
				half3 Subsurface_Color1722_g78013 = ( (_SubsurfaceColor).rgb * Blend_Albedo_Colored863_g78013 * Blend_Albedo_Highlight5771_g78013 );
				half Global_Subsurface4041_g78013 = TVE_SubsurfaceValue;
				float4 temp_output_93_19_g78027 = TVE_ExtrasCoords;
				float3 lerpResult4827_g78013 = lerp( WorldPosition3905_g78013 , ObjectPosition4223_g78013 , _ExtrasPositionMode);
				half2 UV96_g78027 = ( (temp_output_93_19_g78027).zw + ( (temp_output_93_19_g78027).xy * (lerpResult4827_g78013).xz ) );
				float temp_output_84_0_g78027 = _LayerExtrasValue;
				float4 lerpResult109_g78027 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, UV96_g78027,temp_output_84_0_g78027, 0.0 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g78027]);
				half4 Global_Extras_Params5440_g78013 = lerpResult109_g78027;
				float4 break456_g78020 = Global_Extras_Params5440_g78013;
				half Global_Extras_Overlay156_g78013 = break456_g78020.z;
				half Overlay_Value5738_g78013 = ( _GlobalOverlay * Global_Extras_Overlay156_g78013 );
				half Subsurface_Intensity1752_g78013 = ( _SubsurfaceValue * Global_Subsurface4041_g78013 * ( 1.0 - Overlay_Value5738_g78013 ) );
				half Subsurface_Mask1557_g78013 = ( Main_Mask_Remap5765_g78013 * Blend_Mask_Invert6260_g78013 );
				...
				half3 Blend_Albedo_Subsurface149_g78013 = ( Blend_Albedo_Colored863_g78013 + Subsurface_Approximation1693_g78013 );
				half3 Global_OverlayColor1758_g78013 = (TVE_OverlayColor).rgb;
				float3 vertexToFrag5058_g78013 = packedInput.ase_texcoord9.xyz;
				...
				float temp_output_7_0_g78065 = 0.1;
				half Global_OverlayHeightStart5667_g78013 = TVE_OverlayHeightStart;
				float temp_output_7_0_g78061 = Global_OverlayHeightStart5667_g78013;
				half Global_OverlayHeightEnd5668_g78013 = TVE_OverlayHeightEnd;
				half Overlay_Height5651_g78013 = saturate( ( ( (WorldPosition3905_g78013).y - temp_output_7_0_g78061 ) / ( Global_OverlayHeightEnd5668_g78013 - temp_output_7_0_g78061 ) ) );
				half Overlay_Mask_High6064_g78013 = ( saturate( ( ( ( Overlay_Value5738_g78013 * Overlay_Projection6081_g78013 * Overlay_Variation4560_g78013 * saturate( ( Blend_Albedo_Grayscale5939_g78013 * 5.0 ) ) ) - temp_output_7_0_g78065 ) / ( 0.3 - temp_output_7_0_g78065 ) ) ) * Overlay_Height5651_g78013 );
				half Overlay_Mask269_g78013 = Overlay_Mask_High6064_g78013;
				float3 lerpResult336_g78013 = lerp( Blend_Albedo_Subsurface149_g78013 , Global_OverlayColor1758_g78013 , Overlay_Mask269_g78013);
				half3 Final_Albedo359_g78013 = lerpResult336_g78013;
				
				float3 unpack4112_g78013 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MainNormalTex, sampler_Linear_Repeat, Main_UVs15_g78013 ), _MainNormalValue );
				unpack4112_g78013.z = lerp( 1, unpack4112_g78013.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g78013 = unpack4112_g78013;
				float3 lerpResult3372_g78013 = lerp( float3( 0,0,1 ) , Main_Normal137_g78013 , _DetailNormalValue);
				float3 unpack4114_g78013 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_Linear_Repeat, Second_UVs17_g78013 ), _SecondNormalValue );
				unpack4114_g78013.z = lerp( 1, unpack4114_g78013.z, saturate(_SecondNormalValue) );
				half3 Second_Normal179_g78013 = unpack4114_g78013;
				float3 lerpResult3376_g78013 = lerp( Main_Normal137_g78013 , BlendNormal( lerpResult3372_g78013 , Second_Normal179_g78013 ) , Blend_Mask147_g78013);
				#ifdef TVE_FEATURE_DETAIL
				float3 staticSwitch267_g78013 = lerpResult3376_g78013;
				#else
				float3 staticSwitch267_g78013 = Main_Normal137_g78013;
				#endif
				float3 temp_output_13_0_g78069 = staticSwitch267_g78013;
				float3 switchResult12_g78069 = (((isFrontFace>0)?(temp_output_13_0_g78069):(( temp_output_13_0_g78069 * _render_normals ))));
				half3 Blend_Normal312_g78013 = switchResult12_g78069;
				half3 Final_Normal366_g78013 = Blend_Normal312_g78013;
				
				half Render_Specular4861_g78013 = _RenderSpecular;
				float3 temp_cast_10 = (( 0.04 * Render_Specular4861_g78013 )).xxx;
				...
				half Global_Extras_Emissive4203_g78013 = break456_g78020.x;
				...
				half Final_Smoothness371_g78013 = lerpResult343_g78013;
				half Global_Extras_Wetness305_g78013 = break456_g78020.y;
				float lerpResult3673_g78013 = lerp( 0.0 , Global_Extras_Wetness305_g78013 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g78013 = saturate( ( Final_Smoothness371_g78013 + lerpResult3673_g78013 ) );
				...
				float localCustomAlphaClip19_g78110 = ( 0.0 );
				...
				half Global_Extras_Alpha1033_g78013 = saturate( break456_g78020.w );
				float lerpResult5154_g78013 = lerp( 0.1 , Global_MeshVariation5104_g78013 , _AlphaVariationValue);
				...
				float lerpResult16_g78105 = lerp( 1.0 , lerpResult5203_g78013 , TVE_Enabled);
				half Global_Alpha315_g78013 = lerpResult16_g78105;
				float vertexToFrag11_g78104 = packedInput.ase_texcoord7.w;
				half Fade_Camera3743_g78013 = vertexToFrag11_g78104;
				half Fade_Always6228_g78013 = ( Fade_Camera3743_g78013 * ( 1.0 - _FadeConstantValue ) );
				...
				float lerpResult3993_g78013 = lerp( 1.0 , saturate( abs( dotResult3851_g78013 ) ) , _FadeGlancingValue);
				half Fade_Glancing3853_g78013 = lerpResult3993_g78013;
				half Fade_Mask5149_g78013 = ( 1.0 * Blend_Mask_Invert6260_g78013 );
				float lerpResult5141_g78013 = lerp( 1.0 , Fade_Glancing3853_g78013 , Fade_Mask5149_g78013);
				half Fade_Effects5360_g78013 = lerpResult5141_g78013;
				float4 tex3DNode27_g78107 = SAMPLE_TEXTURE3D( TVE_ScreenTex3D, sampler_Linear_Repeat, ( TVE_ScreenTexCoord * WorldPosition3905_g78013 ) );
				float temp_output_5865_0_g78013 = saturate( ( ( ( Fade_Always6228_g78013 * Fade_Effects5360_g78013 ) - tex3DNode27_g78107.r ) + ( ( Fade_Always6228_g78013 * Fade_Effects5360_g78013 ) * 0.5 ) + AlphaTreshold2132_g78013 ) );
				half Fade_Alpha3727_g78013 = temp_output_5865_0_g78013;
				float temp_output_661_0_g78013 = ( Blend_Alpha6157_g78013 * Global_Alpha315_g78013 * Fade_Alpha3727_g78013 );
				half Alpha34_g78109 = temp_output_661_0_g78013;
				float temp_output_3_0_g78110 = Alpha34_g78109;
				float Alpha19_g78110 = temp_output_3_0_g78110;
				float temp_output_15_0_g78110 = AlphaTreshold2132_g78013;
				float Treshold19_g78110 = temp_output_15_0_g78110;
				{
				#if defined (TVE_FEATURE_CLIP)
				#if defined (TVE_IS_HD_PIPELINE)
				#if !defined (SHADERPASS_FORWARD_BYPASS_ALPHA_TEST)
				clip(Alpha19_g78110 - Treshold19_g78110);
				#endif
				...
				half Final_Alpha914_g78013 = saturate( ( Alpha19_g78110 * Blend_Color_Alpha6167_g78013 ) );
				
				surfaceDescription.BaseColor = Final_Albedo359_g78013;
				surfaceDescription.Normal = Final_Normal366_g78013;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = temp_cast_10;
				#endif

				surfaceDescription.Emission = Final_Emissive2476_g78013;
				surfaceDescription.Smoothness = Final_SmoothnessAndWetness4130_g78013;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 VertexPosition3588_g78013 = inputMesh.positionOS;
				float3 appendResult60_g78052 = (float3(inputMesh.uv3.x , inputMesh.uv3.z , inputMesh.uv3.y));
				half3 Mesh_PivotsData2831_g78013 = ( appendResult60_g78052 * _VertexPivotMode );
				half3 Mesh_PivotsOS2291_g78013 = Mesh_PivotsData2831_g78013;
				float3 temp_output_2283_0_g78013 = ( VertexPosition3588_g78013 - Mesh_PivotsOS2291_g78013 );
				half3 VertexPos40_g78015 = temp_output_2283_0_g78013;
				...
				half Input_MeshHeight388_g78086 = Mesh_Height1524_g78013;
				half ObjectData20_g78087 = ( Input_MeshHeight388_g78086 * 2.0 );
				float enc62_g78054 = inputMesh.uv0.w;
				float2 localDecodeFloatToVector262_g78054 = DecodeFloatToVector2( enc62_g78054 );
				float2 break63_g78054 = ( localDecodeFloatToVector262_g78054 * 100.0 );
				float Bounds_Height5230_g78013 = break63_g78054.x;
				half Input_BoundsHeight390_g78086 = Bounds_Height5230_g78013;
				...
				half Final_MotionAmplitude418_g78096 = ( Input_MotionAmplitude384_g78096 * Input_GlobalWind407_g78096 * pow( Input_GlobalNoise411_g78096 , lerpResult413_g78096 ) );
				half Input_Squash58_g78096 = _MotionAmplitude_20;
				float enc59_g78054 = inputMesh.uv0.z;
				float2 localDecodeFloatToVector259_g78054 = DecodeFloatToVector2( enc59_g78054 );
				float2 break61_g78054 = localDecodeFloatToVector259_g78054;
				half Mesh_Motion_2060_g78013 = break61_g78054.x;
				half Input_MeshMotion_20388_g78096 = Mesh_Motion_2060_g78013;
				...
				float2 appendResult21_g78054 = (float2(inputMesh.uv1.z , inputMesh.uv1.w));
				float2 Mesh_DetailCoord3_g78013 = appendResult21_g78054;
				float2 lerpResult1545_g78013 = lerp( inputMesh.uv0.xy , Mesh_DetailCoord3_g78013 , _DetailCoordMode);
				float2 vertexToFrag11_g78021 = ( ( lerpResult1545_g78013 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord3.xy = vertexToFrag11_g78021;
				half Mesh_DetailMask90_g78013 = inputMesh.ase_color.b;
				float vertexToFrag11_g78066 = Mesh_DetailMask90_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord3.z = vertexToFrag11_g78066;
				float temp_output_7_0_g78075 = _GradientMinValue;
				half Gradient_Tint2784_g78013 = saturate( ( ( Mesh_Height1524_g78013 - temp_output_7_0_g78075 ) / ( _GradientMaxValue - temp_output_7_0_g78075 ) ) );
				float vertexToFrag11_g78072 = Gradient_Tint2784_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord3.w = vertexToFrag11_g78072;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag3890_g78013;
				...
				float lerpResult4755_g78013 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g78103 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g78103 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g78104 = lerpResult4755_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord4.w = vertexToFrag11_g78104;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 lerpResult6223_g78013 = lerp( float3( 1,1,1 ) , (tex2DNode29_g78013).rgb , _MainAlbedoValue);
				half3 Main_Albedo99_g78013 = ( (_MainColor).rgb * lerpResult6223_g78013 );
				float2 vertexToFrag11_g78021 = packedInput.ase_texcoord3.xy;
				half2 Second_UVs17_g78013 = vertexToFrag11_g78021;
				float4 tex2DNode89_g78013 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g78013 );
				float3 lerpResult6225_g78013 = lerp( float3( 1,1,1 ) , (tex2DNode89_g78013).rgb , _SecondAlbedoValue);
				half3 Second_Albedo153_g78013 = ( (_SecondColor).rgb * lerpResult6225_g78013 );
				...
				float lerpResult1327_g78013 = lerp( Main_Mask57_g78013 , Second_Mask81_g78013 , _DetailMaskMode);
				float lerpResult4058_g78013 = lerp( lerpResult1327_g78013 , ( 1.0 - lerpResult1327_g78013 ) , _DetailMaskInvertMode);
				float vertexToFrag11_g78066 = packedInput.ase_texcoord3.z;
				half Blend_Source1540_g78013 = vertexToFrag11_g78066;
				float clampResult6215_g78013 = clamp( ( lerpResult4058_g78013 * Blend_Source1540_g78013 ) , 0.01 , 0.99 );
				float temp_output_7_0_g78112 = _DetailBlendMinValue;
				half Blend_Mask147_g78013 = ( saturate( ( ( clampResult6215_g78013 - temp_output_7_0_g78112 ) / ( _DetailBlendMaxValue - temp_output_7_0_g78112 ) ) ) * _DetailMode );
				...
				#endif
				half3 Blend_Albedo265_g78013 = staticSwitch255_g78013;
				float vertexToFrag11_g78072 = packedInput.ase_texcoord3.w;
				float3 lerpResult2779_g78013 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g78072);
				float clampResult5814_g78013 = clamp( Main_Mask57_g78013 , 0.01 , 0.99 );
				float temp_output_7_0_g78111 = _MainMaskMinValue;
				half Main_Mask_Remap5765_g78013 = saturate( ( ( clampResult5814_g78013 - temp_output_7_0_g78111 ) / ( _MainMaskMaxValue - temp_output_7_0_g78111 ) ) );
				...
				float3 temp_cast_1 = (Blend_Albedo_Grayscale5939_g78013).xxx;
				float4 temp_output_91_19_g78031 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g78013 = packedInput.ase_texcoord4.xyz;
				float3 WorldPosition3905_g78013 = vertexToFrag3890_g78013;
				...
				float lerpResult16_g78105 = lerp( 1.0 , lerpResult5203_g78013 , TVE_Enabled);
				half Global_Alpha315_g78013 = lerpResult16_g78105;
				float vertexToFrag11_g78104 = packedInput.ase_texcoord4.w;
				half Fade_Camera3743_g78013 = vertexToFrag11_g78104;
				half Fade_Always6228_g78013 = ( Fade_Camera3743_g78013 * ( 1.0 - _FadeConstantValue ) );
				float3 normalizeResult3971_g78013 = normalize( cross( ddy( ase_worldPos ) , ddx( ase_worldPos ) ) );
				float3 NormalsWS_Derivates3972_g78013 = normalizeResult3971_g78013;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 appendResult21_g78054 = (float2(inputMesh.ase_texcoord1.z , inputMesh.ase_texcoord1.w));
				float2 Mesh_DetailCoord3_g78013 = appendResult21_g78054;
				float2 lerpResult1545_g78013 = lerp( inputMesh.ase_texcoord.xy , Mesh_DetailCoord3_g78013 , _DetailCoordMode);
				float2 vertexToFrag11_g78021 = ( ( lerpResult1545_g78013 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord2.xy = vertexToFrag11_g78021;
				half Mesh_DetailMask90_g78013 = inputMesh.ase_color.b;
				float vertexToFrag11_g78066 = Mesh_DetailMask90_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord2.z = vertexToFrag11_g78066;
				outputPackedVaryingsMeshToPS.ase_texcoord3.xyz = vertexToFrag3890_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord4.xyz = vertexToFrag4224_g78013;
				float temp_output_7_0_g78103 = TVE_CameraFadeStart;
				float lerpResult4755_g78013 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g78103 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g78103 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g78104 = lerpResult4755_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord2.w = vertexToFrag11_g78104;
					...
					)
			{
				...
				float4 tex2DNode29_g78013 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g78013 );
				half Main_Alpha316_g78013 = tex2DNode29_g78013.a;
				float2 vertexToFrag11_g78021 = packedInput.ase_texcoord2.xy;
				half2 Second_UVs17_g78013 = vertexToFrag11_g78021;
				float4 tex2DNode89_g78013 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g78013 );
				half Second_Alpha5007_g78013 = tex2DNode89_g78013.a;
				float4 tex2DNode35_g78013 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g78013 );
				...
				float lerpResult1327_g78013 = lerp( Main_Mask57_g78013 , Second_Mask81_g78013 , _DetailMaskMode);
				float lerpResult4058_g78013 = lerp( lerpResult1327_g78013 , ( 1.0 - lerpResult1327_g78013 ) , _DetailMaskInvertMode);
				float vertexToFrag11_g78066 = packedInput.ase_texcoord2.z;
				half Blend_Source1540_g78013 = vertexToFrag11_g78066;
				float clampResult6215_g78013 = clamp( ( lerpResult4058_g78013 * Blend_Source1540_g78013 ) , 0.01 , 0.99 );
				float temp_output_7_0_g78112 = _DetailBlendMinValue;
				half Blend_Mask147_g78013 = ( saturate( ( ( clampResult6215_g78013 - temp_output_7_0_g78112 ) / ( _DetailBlendMaxValue - temp_output_7_0_g78112 ) ) ) * _DetailMode );
				...
				half Blend_Alpha6157_g78013 = staticSwitch6158_g78013;
				float4 temp_output_93_19_g78027 = TVE_ExtrasCoords;
				float3 vertexToFrag3890_g78013 = packedInput.ase_texcoord3.xyz;
				float3 WorldPosition3905_g78013 = vertexToFrag3890_g78013;
				...
				float lerpResult16_g78105 = lerp( 1.0 , lerpResult5203_g78013 , TVE_Enabled);
				half Global_Alpha315_g78013 = lerpResult16_g78105;
				float vertexToFrag11_g78104 = packedInput.ase_texcoord2.w;
				half Fade_Camera3743_g78013 = vertexToFrag11_g78104;
				half Fade_Always6228_g78013 = ( Fade_Camera3743_g78013 * ( 1.0 - _FadeConstantValue ) );
				float3 normalizeResult2169_g78013 = normalize( V );
				float3 ViewDir_Normalized3963_g78013 = normalizeResult2169_g78013;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 lerpResult1545_g78013 = lerp( inputMesh.ase_texcoord.xy , Mesh_DetailCoord3_g78013 , _DetailCoordMode);
				float2 vertexToFrag11_g78021 = ( ( lerpResult1545_g78013 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord4.xy = vertexToFrag11_g78021;
				half Mesh_DetailMask90_g78013 = inputMesh.ase_color.b;
				float vertexToFrag11_g78066 = Mesh_DetailMask90_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord4.z = vertexToFrag11_g78066;
				
				outputPackedVaryingsMeshToPS.ase_texcoord5.xyz = vertexToFrag3890_g78013;
				...
				half Gradient_Tint2784_g78013 = saturate( ( ( Mesh_Height1524_g78013 - temp_output_7_0_g78075 ) / ( _GradientMaxValue - temp_output_7_0_g78075 ) ) );
				float vertexToFrag11_g78072 = Gradient_Tint2784_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord4.w = vertexToFrag11_g78072;
				
				float temp_output_7_0_g78103 = TVE_CameraFadeStart;
				float lerpResult4755_g78013 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g78103 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g78103 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g78104 = lerpResult4755_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord5.w = vertexToFrag11_g78104;
					...
					)
			{
				...
				half3 Main_Normal137_g78013 = unpack4112_g78013;
				float3 lerpResult3372_g78013 = lerp( float3( 0,0,1 ) , Main_Normal137_g78013 , _DetailNormalValue);
				float2 vertexToFrag11_g78021 = packedInput.ase_texcoord4.xy;
				half2 Second_UVs17_g78013 = vertexToFrag11_g78021;
				float3 unpack4114_g78013 = UnpackNormalScale( SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_Linear_Repeat, Second_UVs17_g78013 ), _SecondNormalValue );
				unpack4114_g78013.z = lerp( 1, unpack4114_g78013.z, saturate(_SecondNormalValue) );
				half3 Second_Normal179_g78013 = unpack4114_g78013;
				...
				float lerpResult1327_g78013 = lerp( Main_Mask57_g78013 , Second_Mask81_g78013 , _DetailMaskMode);
				float lerpResult4058_g78013 = lerp( lerpResult1327_g78013 , ( 1.0 - lerpResult1327_g78013 ) , _DetailMaskInvertMode);
				float vertexToFrag11_g78066 = packedInput.ase_texcoord4.z;
				half Blend_Source1540_g78013 = vertexToFrag11_g78066;
				float clampResult6215_g78013 = clamp( ( lerpResult4058_g78013 * Blend_Source1540_g78013 ) , 0.01 , 0.99 );
				float temp_output_7_0_g78112 = _DetailBlendMinValue;
				half Blend_Mask147_g78013 = ( saturate( ( ( clampResult6215_g78013 - temp_output_7_0_g78112 ) / ( _DetailBlendMaxValue - temp_output_7_0_g78112 ) ) ) * _DetailMode );
				...
				half Global_OverlaySmoothness311_g78013 = TVE_OverlaySmoothness;
				float4 temp_output_93_19_g78027 = TVE_ExtrasCoords;
				float3 vertexToFrag3890_g78013 = packedInput.ase_texcoord5.xyz;
				float3 WorldPosition3905_g78013 = vertexToFrag3890_g78013;
				...
				#endif
				half3 Blend_Albedo265_g78013 = staticSwitch255_g78013;
				float vertexToFrag11_g78072 = packedInput.ase_texcoord4.w;
				float3 lerpResult2779_g78013 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g78072);
				float clampResult5814_g78013 = clamp( Main_Mask57_g78013 , 0.01 , 0.99 );
				float temp_output_7_0_g78111 = _MainMaskMinValue;
				half Main_Mask_Remap5765_g78013 = saturate( ( ( clampResult5814_g78013 - temp_output_7_0_g78111 ) / ( _MainMaskMaxValue - temp_output_7_0_g78111 ) ) );
				...
				float clampResult6091_g78013 = clamp( Mesh_Occlusion318_g78013 , 0.01 , 0.99 );
				float temp_output_7_0_g78068 = _VertexOcclusionMinValue;
				float3 lerpResult2945_g78013 = lerp( (_VertexOcclusionColor).rgb , temp_cast_5 , saturate( ( ( clampResult6091_g78013 - temp_output_7_0_g78068 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g78068 ) ) ));
				half3 Vertex_Occlusion648_g78013 = lerpResult2945_g78013;
				half3 Blend_Albedo_Tinted2808_g78013 = ( Blend_Albedo265_g78013 * Blend_Albedo_Gradient5769_g78013 * Blend_Albedo_Noise5770_g78013 * Vertex_Occlusion648_g78013 );
				float dotResult5937_g78013 = dot( Blend_Albedo_Tinted2808_g78013 , float3(0.2126,0.7152,0.0722) );
				half Blend_Albedo_Grayscale5939_g78013 = dotResult5937_g78013;
				...
				float lerpResult16_g78105 = lerp( 1.0 , lerpResult5203_g78013 , TVE_Enabled);
				half Global_Alpha315_g78013 = lerpResult16_g78105;
				float vertexToFrag11_g78104 = packedInput.ase_texcoord5.w;
				half Fade_Camera3743_g78013 = vertexToFrag11_g78104;
				half Fade_Always6228_g78013 = ( Fade_Camera3743_g78013 * ( 1.0 - _FadeConstantValue ) );
				float3 normalizeResult2169_g78013 = normalize( V );
				float3 ViewDir_Normalized3963_g78013 = normalizeResult2169_g78013;
		...
		Pass
		{
				...
				)
			{
				...
				#endif
				float3 temp_output_13_0_g78069 = staticSwitch267_g78013;
				float3 switchResult12_g78069 = (((ase_vface>0)?(temp_output_13_0_g78069):(( temp_output_13_0_g78069 * _render_normals ))));
				half3 Blend_Normal312_g78013 = switchResult12_g78069;
				half3 Final_Normal366_g78013 = Blend_Normal312_g78013;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float2 lerpResult1545_g78013 = lerp( inputMesh.ase_texcoord.xy , Mesh_DetailCoord3_g78013 , _DetailCoordMode);
				float2 vertexToFrag11_g78021 = ( ( lerpResult1545_g78013 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				outputPackedVaryingsMeshToPS.ase_texcoord8.xy = vertexToFrag11_g78021;
				half Mesh_DetailMask90_g78013 = inputMesh.ase_color.b;
				float vertexToFrag11_g78066 = Mesh_DetailMask90_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord8.z = vertexToFrag11_g78066;
				float temp_output_7_0_g78075 = _GradientMinValue;
				half Gradient_Tint2784_g78013 = saturate( ( ( Mesh_Height1524_g78013 - temp_output_7_0_g78075 ) / ( _GradientMaxValue - temp_output_7_0_g78075 ) ) );
				float vertexToFrag11_g78072 = Gradient_Tint2784_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord8.w = vertexToFrag11_g78072;
				outputPackedVaryingsMeshToPS.ase_texcoord9.xyz = vertexToFrag3890_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord10.xyz = vertexToFrag4224_g78013;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float3 vertexToFrag5058_g78013 = ase_worldNormal;
				outputPackedVaryingsMeshToPS.ase_texcoord11.xyz = vertexToFrag5058_g78013;
				
				float temp_output_7_0_g78103 = TVE_CameraFadeStart;
				float lerpResult4755_g78013 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g78103 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g78103 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g78104 = lerpResult4755_g78013;
				outputPackedVaryingsMeshToPS.ase_texcoord9.w = vertexToFrag11_g78104;
						...
						)
			{
				...
				float3 lerpResult6223_g78013 = lerp( float3( 1,1,1 ) , (tex2DNode29_g78013).rgb , _MainAlbedoValue);
				half3 Main_Albedo99_g78013 = ( (_MainColor).rgb * lerpResult6223_g78013 );
				float2 vertexToFrag11_g78021 = packedInput.ase_texcoord8.xy;
				half2 Second_UVs17_g78013 = vertexToFrag11_g78021;
				float4 tex2DNode89_g78013 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g78013 );
				float3 lerpResult6225_g78013 = lerp( float3( 1,1,1 ) , (tex2DNode89_g78013).rgb , _SecondAlbedoValue);
				half3 Second_Albedo153_g78013 = ( (_SecondColor).rgb * lerpResult6225_g78013 );
				...
				float lerpResult1327_g78013 = lerp( Main_Mask57_g78013 , Second_Mask81_g78013 , _DetailMaskMode);
				float lerpResult4058_g78013 = lerp( lerpResult1327_g78013 , ( 1.0 - lerpResult1327_g78013 ) , _DetailMaskInvertMode);
				float vertexToFrag11_g78066 = packedInput.ase_texcoord8.z;
				half Blend_Source1540_g78013 = vertexToFrag11_g78066;
				float clampResult6215_g78013 = clamp( ( lerpResult4058_g78013 * Blend_Source1540_g78013 ) , 0.01 , 0.99 );
				float temp_output_7_0_g78112 = _DetailBlendMinValue;
				half Blend_Mask147_g78013 = ( saturate( ( ( clampResult6215_g78013 - temp_output_7_0_g78112 ) / ( _DetailBlendMaxValue - temp_output_7_0_g78112 ) ) ) * _DetailMode );
				...
				#endif
				half3 Blend_Albedo265_g78013 = staticSwitch255_g78013;
				float vertexToFrag11_g78072 = packedInput.ase_texcoord8.w;
				float3 lerpResult2779_g78013 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g78072);
				float clampResult5814_g78013 = clamp( Main_Mask57_g78013 , 0.01 , 0.99 );
				float temp_output_7_0_g78111 = _MainMaskMinValue;
				half Main_Mask_Remap5765_g78013 = saturate( ( ( clampResult5814_g78013 - temp_output_7_0_g78111 ) / ( _MainMaskMaxValue - temp_output_7_0_g78111 ) ) );
				...
				float3 temp_cast_1 = (Blend_Albedo_Grayscale5939_g78013).xxx;
				float4 temp_output_91_19_g78031 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g78013 = packedInput.ase_texcoord9.xyz;
				float3 WorldPosition3905_g78013 = vertexToFrag3890_g78013;
				float3 vertexToFrag4224_g78013 = packedInput.ase_texcoord10.xyz;
				half3 ObjectData20_g78043 = vertexToFrag4224_g78013;
				half3 WorldData19_g78043 = vertexToFrag3890_g78013;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g78043 = WorldData19_g78043;
				...
				half3 Blend_Albedo_Subsurface149_g78013 = ( Blend_Albedo_Colored863_g78013 + Subsurface_Approximation1693_g78013 );
				half3 Global_OverlayColor1758_g78013 = (TVE_OverlayColor).rgb;
				float3 vertexToFrag5058_g78013 = packedInput.ase_texcoord11.xyz;
				half3 World_Normal4101_g78013 = vertexToFrag5058_g78013;
				float lerpResult5730_g78013 = lerp( (World_Normal4101_g78013).y , packedInput.ase_normal.y , Global_DynamicMode5112_g78013);
				float lerpResult5885_g78013 = lerp( 0.4 , 1.0 , saturate( lerpResult5730_g78013 ));
				half Overlay_Projection6081_g78013 = lerpResult5885_g78013;
				...
				float lerpResult16_g78105 = lerp( 1.0 , lerpResult5203_g78013 , TVE_Enabled);
				half Global_Alpha315_g78013 = lerpResult16_g78105;
				float vertexToFrag11_g78104 = packedInput.ase_texcoord9.w;
				half Fade_Camera3743_g78013 = vertexToFrag11_g78104;
				half Fade_Always6228_g78013 = ( Fade_Camera3743_g78013 * ( 1.0 - _FadeConstantValue ) );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 normalizeResult3971_g78013 = normalize( cross( ddy( ase_worldPos ) , ddx( ase_worldPos ) ) );
        ...
        Pass
        {
			...
			VertexOutput VertexFunction(VertexInput inputMesh  )
			{
				...
				float2 lerpResult1545_g78013 = lerp( inputMesh.ase_texcoord.xy , Mesh_DetailCoord3_g78013 , _DetailCoordMode);
				float2 vertexToFrag11_g78021 = ( ( lerpResult1545_g78013 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				o.ase_texcoord3.xy = vertexToFrag11_g78021;
				half Mesh_DetailMask90_g78013 = inputMesh.ase_color.b;
				float vertexToFrag11_g78066 = Mesh_DetailMask90_g78013;
				o.ase_texcoord3.z = vertexToFrag11_g78066;
				o.ase_texcoord4.xyz = vertexToFrag3890_g78013;
				o.ase_texcoord5.xyz = vertexToFrag4224_g78013;
				float temp_output_7_0_g78103 = TVE_CameraFadeStart;
				float lerpResult4755_g78013 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g78103 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g78103 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g78104 = lerpResult4755_g78013;
				o.ase_texcoord3.w = vertexToFrag11_g78104;
					...
					)
			{
				...
				float lerpResult16_g78105 = lerp( 1.0 , lerpResult5203_g78013 , TVE_Enabled);
				half Global_Alpha315_g78013 = lerpResult16_g78105;
				float vertexToFrag11_g78104 = packedInput.ase_texcoord3.w;
				half Fade_Camera3743_g78013 = vertexToFrag11_g78104;
				half Fade_Always6228_g78013 = ( Fade_Camera3743_g78013 * ( 1.0 - _FadeConstantValue ) );
				float3 ase_worldPos = packedInput.ase_texcoord6.xyz;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
...
ASEEND*/
//CHKSM=61D4F006DD424E186BCD3D5D57889D34F4F69CC9
