...
using ProceduralWorlds.HDRPTOD;
#endif
#elif HDRPTIMEOFDAY && HDPipeline && UNITY_2021_2_OR_NEWER
using ProceduralWorlds.HDRPTOD;
#endif
...
#if GAIA_PRO_PRESENT
            ProceduralWorldsGlobalWeather instance = ProceduralWorldsGlobalWeather.Instance;
            if (instance == null)
                instance = FindObjectOfType<ProceduralWorldsGlobalWeather>();
            m_gaiaProExists = instance != null;
