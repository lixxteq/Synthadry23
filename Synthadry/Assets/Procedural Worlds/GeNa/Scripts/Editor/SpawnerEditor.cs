        ...
        public override void OnInspectorGUI()
        {
            ...
            m_scrollPosition = EditorGUILayout.BeginScrollView(m_scrollPosition, Styles.panel);
            {
                ...
                EditorGUI.BeginChangeCheck();
                {
                    ...
                    Color baseColor = m_baseColor; //EditorGUIUtility.isProSkin ? m_baseColor : m_baseColor;
                    ...
                    GUI.color = isPrefabAndTemp ? baseColor : oldColor;
                    Color oldBackColor = GUI.backgroundColor;
                    GUI.backgroundColor = isPrefabAndTemp ? backgroundColor : oldColor;
                    // Overview Panel
