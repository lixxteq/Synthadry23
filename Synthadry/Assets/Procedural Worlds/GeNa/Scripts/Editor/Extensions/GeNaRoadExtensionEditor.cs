    ...
    public class GeNaRoadExtensionEditor : GeNaSplineExtensionEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                extension.SeparateYScale = m_editorUtils.Toggle("SeparateYScale", extension.SeparateYScale, HelpEnabled);
                EditorGUI.indentLevel++;
                if (extension.SeparateYScale)
                    extension.Height = m_editorUtils.Slider("HeightScale", extension.Height, 1.001f, 15.0f, HelpEnabled);
                EditorGUI.indentLevel--;
                ...
                extension.CrossSectionOverride = m_editorUtils.ObjectField("CrossSectionOverride", extension.CrossSectionOverride, typeof(RoadCrossSectionOverride), true) as RoadCrossSectionOverride;
